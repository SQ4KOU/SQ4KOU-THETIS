...
& (Join-Path $PSScriptRoot 'Apply-Flex5000NoHpsdrCalls.ps1')
& (Join-Path $PSScriptRoot 'Apply-Flex5000StartupFix.ps1')
...
$manifest = @(
    ...
    'HPSDR_NETWORKIO_PINVOKE=STUBBED_FOR_FLEX5000',
    'MINISPEC_INIT=AFTER_CHANNELMASTER_CREATE',
    'DIRECTX_FALLBACK=WARP_ON_HARDWARE_UNSUPPORTED',
