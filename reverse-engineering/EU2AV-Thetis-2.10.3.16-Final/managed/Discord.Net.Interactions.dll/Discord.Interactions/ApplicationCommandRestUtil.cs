...
internal static class ApplicationCommandRestUtil
{
	...
	public static SlashCommandProperties ToApplicationCommandProps(this SlashCommandInfo commandInfo)
	{
		...
		SlashCommandProperties slashCommandProperties = new SlashCommandBuilder
		{
			...
			IntegrationTypes = ((commandInfo.IntegrationTypes != null) ? new HashSet<ApplicationIntegrationType>(commandInfo.IntegrationTypes) : null),
			ContextTypes = ((commandInfo.ContextTypes != null) ? new HashSet<InteractionContextType>(commandInfo.ContextTypes) : null)
	...
	private static void ParseModuleModel(this ModuleInfo moduleInfo, List<ApplicationCommandProperties> args, bool ignoreDontRegister)
	{
		...
		SlashCommandProperties slashCommandProperties = new SlashCommandBuilder
		{
			...
			IntegrationTypes = ((moduleInfo.IntegrationTypes != null) ? new HashSet<ApplicationIntegrationType>(moduleInfo.IntegrationTypes) : null),
			ContextTypes = ((moduleInfo.ContextTypes != null) ? new HashSet<InteractionContextType>(moduleInfo.ContextTypes) : null)
	...
	public static ApplicationCommandProperties ToApplicationCommandProps(this IApplicationCommand command)
	{
		...
		case ApplicationCommandType.Slash:
		{
			SlashCommandProperties obj = new SlashCommandProperties
			{
				...
				DefaultMemberPermissions = ((command.DefaultMemberPermissions.RawValue == 0L) ? default(Optional<GuildPermission>) : ((Optional<GuildPermission>)(GuildPermission)command.DefaultMemberPermissions.RawValue)),
			...
			obj.ContextTypes = ((command.ContextTypes != null) ? ((Optional<HashSet<InteractionContextType>>)new HashSet<InteractionContextType>(command.ContextTypes)) : Optional<HashSet<InteractionContextType>>.Unspecified);
			obj.IntegrationTypes = ((command.IntegrationTypes != null) ? ((Optional<HashSet<ApplicationIntegrationType>>)new HashSet<ApplicationIntegrationType>(command.IntegrationTypes)) : Optional<HashSet<ApplicationIntegrationType>>.Unspecified);
			return obj;
		}
		case ApplicationCommandType.User:
			return new UserCommandProperties
			{
				...
				ContextTypes = ((command.ContextTypes != null) ? ((Optional<HashSet<InteractionContextType>>)new HashSet<InteractionContextType>(command.ContextTypes)) : Optional<HashSet<InteractionContextType>>.Unspecified),
				IntegrationTypes = ((command.IntegrationTypes != null) ? ((Optional<HashSet<ApplicationIntegrationType>>)new HashSet<ApplicationIntegrationType>(command.IntegrationTypes)) : Optional<HashSet<ApplicationIntegrationType>>.Unspecified)
			};
