...
internal sealed class ConversionOperatorDeclarationSyntax : BaseMethodDeclarationSyntax
{
	...
	{
		return new ConversionOperatorDeclarationSyntax(base.Kind, attributeLists, modifiers, implicitOrExplicitKeyword, explicitInterfaceSpecifier, operatorKeyword, checkedKeyword, type, parameterList, body, expressionBody, semicolonToken, diagnostics, GetAnnotations());
	}

	internal override GreenNode SetAnnotations(SyntaxAnnotation[]? annotations)
	{
		return new ConversionOperatorDeclarationSyntax(base.Kind, attributeLists, modifiers, implicitOrExplicitKeyword, explicitInterfaceSpecifier, operatorKeyword, checkedKeyword, type, parameterList, body, expressionBody, semicolonToken, GetDiagnostics(), annotations);
	}
}
