...
internal abstract class CompoundInstrumenter : Instrumenter
{
	...
	public CompoundInstrumenter WithPrevious(Instrumenter previous)
	{
		...
		{
			return WithPreviousImpl(previous);
		}
		return this;
	}
	...
	{
		Previous.InstrumentCatchBlock(original, ref rewrittenSource, ref rewrittenFilterPrologue, ref rewrittenFilter, ref rewrittenBody, ref rewrittenType, factory);
	}
