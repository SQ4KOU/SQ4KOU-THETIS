...
internal static class Map
{
	...
	public static readonly Dictionary<string, JustifyContent> JustifyContentOptions = new Dictionary<string, JustifyContent>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Start,
		...
		{
			Keywords.SpaceBetween,
			JustifyContent.SpaceBetween
		},
		{
			Keywords.SpaceAround,
			JustifyContent.SpaceAround
		},
		{
			Keywords.SpaceEvenly,
	...
	public static readonly Dictionary<string, ITimingFunction> TimingFunctions = new Dictionary<string, ITimingFunction>(StringComparer.OrdinalIgnoreCase)
	{
		...
		{
			Keywords.StepStart,
			new StepsTimingFunction(1, start: true)
		},
		{
			Keywords.StepEnd,
			new StepsTimingFunction(1)
		}
	};
	...
	public static readonly Dictionary<string, UnicodeMode> UnicodeModes = new Dictionary<string, UnicodeMode>(StringComparer.OrdinalIgnoreCase)
	{
		...
		{
			Keywords.BidirectionalOverride,
			UnicodeMode.BidirectionalOverride
		},
		{
			Keywords.Plaintext,
	...
	public static readonly Dictionary<string, Overflow> OverflowModes = new Dictionary<string, Overflow>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Visible,
			Overflow.Visible
	...
	public static readonly Dictionary<string, FillRule> FillRules = new Dictionary<string, FillRule>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Nonzero,
			FillRule.Nonzero
	...
	public static readonly Dictionary<string, FlexWrap> FlexWraps = new Dictionary<string, FlexWrap>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Nowrap,
			FlexWrap.NoWrap
	...
	public static readonly Dictionary<string, IntrinsicSizing> IntrinsicSizings = new Dictionary<string, IntrinsicSizing>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.MaxContent,
			IntrinsicSizing.MaxContent
		},
		{
			Keywords.MinContent,
			IntrinsicSizing.MinContent
		},
		{
			Keywords.FitContent,
			IntrinsicSizing.FitContent
		},
		{
			Keywords.Content,
	...
	public static readonly Dictionary<string, AlignContent> AlignContents = new Dictionary<string, AlignContent>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Center,
			AlignContent.Center
	...
	public static readonly Dictionary<string, AlignItem> AlignItems = new Dictionary<string, AlignItem>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Normal,
			AlignItem.Normal
	...
	public static readonly Dictionary<string, ContainerType> ContainerTypes = new Dictionary<string, ContainerType>(StringComparer.OrdinalIgnoreCase)
	{
		{
			Keywords.Normal,
