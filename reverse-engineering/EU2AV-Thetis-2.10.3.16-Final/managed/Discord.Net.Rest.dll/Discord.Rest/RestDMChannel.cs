...
public class RestDMChannel : RestChannel, IDMChannel, IMessageChannel, IChannel, ISnowflakeEntity, IEntity<ulong>, IPrivateChannel, IRestPrivateChannel, IRestMessageChannel
{
	public RestUser CurrentUser { get; }

	public RestUser Recipient { get; }

	public IReadOnlyCollection<RestUser> Users => (Recipient == null) ? ImmutableArray<RestUser>.Empty : ImmutableArray.Create(CurrentUser, Recipient);
	...
	internal RestDMChannel(BaseDiscordClient discord, ulong id, ulong? recipientId)
		: base(discord, id)
	{
		Recipient = (recipientId.HasValue ? new RestUser(base.Discord, recipientId.Value) : null);
	...
	{
		ulong id = model.Id;
		User[] valueOrDefault = model.Recipients.GetValueOrDefault(null);
		RestDMChannel restDMChannel = new RestDMChannel(discord, id, (valueOrDefault != null) ? new ulong?(valueOrDefault[0].Id) : ((ulong?)null));
	...
	{
		return ChannelHelper.SendMessageAsync(this, base.Discord, text, isTTS, embed, allowedMentions, messageReference, components, stickers, options, embeds, flags, poll);
	}
	...
	{
		return ChannelHelper.SendFileAsync(this, base.Discord, filePath, text, isTTS, embed, allowedMentions, messageReference, components, stickers, options, isSpoiler, embeds, flags, poll);
	}
	...
	{
		return ChannelHelper.SendFileAsync(this, base.Discord, stream, filename, text, isTTS, embed, allowedMentions, messageReference, components, stickers, options, isSpoiler, embeds, flags, poll);
	}
	...
	{
		return ChannelHelper.SendFileAsync(this, base.Discord, attachment, text, isTTS, embed, allowedMentions, messageReference, components, stickers, options, embeds, flags, poll);
	}
	...
	{
		return ChannelHelper.SendFilesAsync(this, base.Discord, attachments, text, isTTS, embed, allowedMentions, messageReference, components, stickers, options, embeds, flags, poll);
	}
	...
	async Task<IUserMessage> IMessageChannel.SendFileAsync(string filePath, string text, bool isTTS, Embed embed, RequestOptions options, bool isSpoiler, AllowedMentions allowedMentions, MessageReference messageReference, MessageComponent components, ISticker[] stickers, Embed[] embeds, MessageFlags flags, PollProperties poll)
	{
		return await SendFileAsync(filePath, text, isTTS, embed, options, isSpoiler, allowedMentions, messageReference, components, stickers, embeds, flags, poll).ConfigureAwait(continueOnCapturedContext: false);
	}
	...
	{
		return await SendFileAsync(stream, filename, text, isTTS, embed, options, isSpoiler, allowedMentions, messageReference, components, stickers, embeds, flags, poll).ConfigureAwait(continueOnCapturedContext: false);
	}
	...
	{
		return await SendFileAsync(attachment, text, isTTS, embed, options, allowedMentions, messageReference, components, stickers, embeds, flags, poll).ConfigureAwait(continueOnCapturedContext: false);
	}
	...
	{
		return await SendFilesAsync(attachments, text, isTTS, embed, options, allowedMentions, messageReference, components, stickers, embeds, flags, poll).ConfigureAwait(continueOnCapturedContext: false);
	}
	...
	{
		return await SendMessageAsync(text, isTTS, embed, options, allowedMentions, messageReference, components, stickers, embeds, flags, poll).ConfigureAwait(continueOnCapturedContext: false);
	}
