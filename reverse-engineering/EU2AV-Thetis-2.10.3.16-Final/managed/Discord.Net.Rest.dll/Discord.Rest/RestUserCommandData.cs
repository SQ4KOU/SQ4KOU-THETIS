...
public class RestUserCommandData : RestCommandBaseData, IUserCommandInteractionData, IApplicationCommandInteractionData, IDiscordInteractionData
{
	...
	internal new static async Task<RestUserCommandData> CreateAsync(DiscordRestClient client, ApplicationCommandInteractionData model, RestGuild guild, ulong? guildId, IRestMessageChannel channel, bool doApiCall)
	{
