...
public class RestMessageCommandData : RestCommandBaseData, IMessageCommandInteractionData, IApplicationCommandInteractionData, IDiscordInteractionData
{
	...
	internal new static async Task<RestMessageCommandData> CreateAsync(DiscordRestClient client, ApplicationCommandInteractionData model, RestGuild guild, ulong? guildId, IRestMessageChannel channel, bool doApiCall)
	{
