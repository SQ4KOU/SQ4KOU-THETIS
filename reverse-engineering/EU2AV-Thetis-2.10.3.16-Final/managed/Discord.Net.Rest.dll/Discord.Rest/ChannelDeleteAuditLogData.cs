...
public class ChannelDeleteAuditLogData : IAuditLogData
{
	...
	private ChannelDeleteAuditLogData(ChannelInfoAuditLogModel model, AuditLogEntry entry)
	{
	...
	internal static ChannelDeleteAuditLogData Create(BaseDiscordClient discord, AuditLogEntry entry, AuditLog log = null)
	{
		return new ChannelDeleteAuditLogData(AuditLogHelper.CreateAuditLogEntityInfo<ChannelInfoAuditLogModel>(entry.Changes, discord).Item1, entry);
	}
}
