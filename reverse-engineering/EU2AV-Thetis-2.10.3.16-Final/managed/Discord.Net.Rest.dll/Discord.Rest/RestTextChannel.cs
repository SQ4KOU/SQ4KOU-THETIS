...
public class RestTextChannel : RestGuildChannel, IRestMessageChannel, IMessageChannel, IChannel, ISnowflakeEntity, IEntity<ulong>, ITextChannel, IMentionable, INestedChannel, IGuildChannel, IDeletable, IIntegrationChannel
{
	...
	{
		RestTextChannel restTextChannel = new RestTextChannel(discord, guild, model.Id, guild?.Id ?? model.GuildId.Value);
