...
public class RestStageChannel : RestVoiceChannel, IStageChannel, IVoiceChannel, ITextChannel, IMessageChannel, IChannel, ISnowflakeEntity, IEntity<ulong>, IMentionable, INestedChannel, IGuildChannel, IDeletable, IIntegrationChannel, IAudioChannel
{
	...
	{
		RestStageChannel restStageChannel = new RestStageChannel(discord, guild, model.Id, guild?.Id ?? model.GuildId.Value);
