...
internal class ApplicationCommandOption
{
	...
	public ApplicationCommandOption(IApplicationCommandOption cmd)
	{
		...
		Dictionary<string, string> dictionary = cmd.NameLocalizations?.ToDictionary((KeyValuePair<string, string> x) => x.Key, (KeyValuePair<string, string> y) => y.Value);
		...
		dictionary = cmd.DescriptionLocalizations?.ToDictionary((KeyValuePair<string, string> x) => x.Key, (KeyValuePair<string, string> y) => y.Value);
	...
	{
		ApplicationCommandOptionChoice[] array = option.Choices?.Select(delegate(ApplicationCommandOptionChoiceProperties x)
		{
			ApplicationCommandOptionChoice obj = new ApplicationCommandOptionChoice
			{
				Name = x.Name,
				Value = x.Value
			};
			Dictionary<string, string> dictionary2 = x.NameLocalizations?.ToDictionary((KeyValuePair<string, string> keyValuePair) => keyValuePair.Key, (KeyValuePair<string, string> y) => y.Value);
			obj.NameLocalizations = ((dictionary2 != null) ? ((Optional<Dictionary<string, string>>)dictionary2) : Optional<Dictionary<string, string>>.Unspecified);
			return obj;
		}).ToArray();
		...
		Dictionary<string, string> dictionary = option.NameLocalizations?.ToDictionary((KeyValuePair<string, string> x) => x.Key, (KeyValuePair<string, string> y) => y.Value);
		NameLocalizations = ((dictionary != null) ? ((Optional<Dictionary<string, string>>)dictionary) : Optional<Dictionary<string, string>>.Unspecified);
		dictionary = option.DescriptionLocalizations?.ToDictionary((KeyValuePair<string, string> x) => x.Key, (KeyValuePair<string, string> y) => y.Value);
		DescriptionLocalizations = ((dictionary != null) ? ((Optional<Dictionary<string, string>>)dictionary) : Optional<Dictionary<string, string>>.Unspecified);
	}
}
