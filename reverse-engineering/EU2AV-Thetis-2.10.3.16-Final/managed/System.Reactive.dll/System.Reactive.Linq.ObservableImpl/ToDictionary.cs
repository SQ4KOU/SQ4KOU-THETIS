...
internal sealed class ToDictionary<TSource, TKey, TElement> : Producer<IDictionary<TKey, TElement>, ToDictionary<TSource, TKey, TElement>._> where TKey : notnull
{
	internal sealed class @_ : Sink<TSource, IDictionary<TKey, TElement>>
	{
		...
		{
			Dictionary<TKey, TElement> dictionary = _dictionary;
			Cleanup();
	...
	protected override @_ CreateSink(IObserver<IDictionary<TKey, TElement>> observer)
	{
