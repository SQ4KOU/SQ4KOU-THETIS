...
public class SKFont : SKObject
{
	...
	public unsafe ushort[] GetGlyphs(ReadOnlySpan<char> text)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe ushort[] GetGlyphs(ReadOnlySpan<byte> text, SKTextEncoding encoding)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	{
		GetGlyphs(MemoryExtensions.AsSpan(text), glyphs);
	}
	...
	{
		return CountGlyphs(MemoryExtensions.AsSpan(text));
	}
	...
	{
		return MeasureText(MemoryExtensions.AsSpan(text), paint);
	}

	public unsafe float MeasureText(ReadOnlySpan<char> text, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float MeasureText(ReadOnlySpan<byte> text, SKTextEncoding encoding, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float MeasureText(IntPtr text, int length, SKTextEncoding encoding, SKPaint paint = null)
	{
	...
	{
		return MeasureText(MemoryExtensions.AsSpan(text), out bounds, paint);
	}

	public unsafe float MeasureText(ReadOnlySpan<char> text, out SKRect bounds, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float MeasureText(ReadOnlySpan<byte> text, SKTextEncoding encoding, out SKRect bounds, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float MeasureText(IntPtr text, int length, SKTextEncoding encoding, out SKRect bounds, SKPaint paint = null)
	{
		fixed (SKRect* bounds2 = &bounds)
		{
	...
	{
		float measuredWidth;
		return BreakText(MemoryExtensions.AsSpan(text), maxWidth, out measuredWidth, paint);
	}
	...
	{
		float measuredWidth;
		return BreakText(text, maxWidth, out measuredWidth, paint);
	}

	public unsafe int BreakText(ReadOnlySpan<char> text, float maxWidth, out float measuredWidth, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	{
		float measuredWidth;
		return BreakText(text, encoding, maxWidth, out measuredWidth, paint);
	}

	public unsafe int BreakText(ReadOnlySpan<byte> text, SKTextEncoding encoding, float maxWidth, out float measuredWidth, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	{
		float measuredWidth;
		return BreakText(text, length, encoding, maxWidth, out measuredWidth, paint);
	}

	public unsafe int BreakText(IntPtr text, int length, SKTextEncoding encoding, float maxWidth, out float measuredWidth, SKPaint paint = null)
	{
		fixed (float* measuredWidth2 = &measuredWidth)
		{
	...
	{
		return GetGlyphPositions(MemoryExtensions.AsSpan(text), origin);
	}

	public unsafe SKPoint[] GetGlyphPositions(ReadOnlySpan<char> text, SKPoint origin = default(SKPoint))
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPoint[] GetGlyphPositions(ReadOnlySpan<byte> text, SKTextEncoding encoding, SKPoint origin = default(SKPoint))
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPoint[] GetGlyphPositions(IntPtr text, int length, SKTextEncoding encoding, SKPoint origin = default(SKPoint))
	{
		return GetGlyphPositions((void*)text, length, encoding, origin);
	}

	public void GetGlyphPositions(string text, Span<SKPoint> offsets, SKPoint origin = default(SKPoint))
	{
		GetGlyphPositions(MemoryExtensions.AsSpan(text), offsets, origin);
	}

	public unsafe void GetGlyphPositions(ReadOnlySpan<char> text, Span<SKPoint> offsets, SKPoint origin = default(SKPoint))
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphPositions(ReadOnlySpan<byte> text, SKTextEncoding encoding, Span<SKPoint> offsets, SKPoint origin = default(SKPoint))
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphPositions(IntPtr text, int length, SKTextEncoding encoding, Span<SKPoint> offsets, SKPoint origin = default(SKPoint))
	{
	...
	public SKPoint[] GetGlyphPositions(ReadOnlySpan<ushort> glyphs, SKPoint origin = default(SKPoint))
	{
	...
	{
		return GetGlyphOffsets(MemoryExtensions.AsSpan(text), origin);
	}

	public unsafe float[] GetGlyphOffsets(ReadOnlySpan<char> text, float origin = 0f)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphOffsets(ReadOnlySpan<byte> text, SKTextEncoding encoding, float origin = 0f)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphOffsets(IntPtr text, int length, SKTextEncoding encoding, float origin = 0f)
	{
	...
	{
		GetGlyphOffsets(MemoryExtensions.AsSpan(text), offsets, origin);
	}

	public unsafe void GetGlyphOffsets(ReadOnlySpan<char> text, Span<float> offsets, float origin = 0f)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphOffsets(ReadOnlySpan<byte> text, SKTextEncoding encoding, Span<float> offsets, float origin = 0f)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphOffsets(IntPtr text, int length, SKTextEncoding encoding, Span<float> offsets, float origin = 0f)
	{
	...
	{
		return GetGlyphWidths(MemoryExtensions.AsSpan(text), paint);
	}

	public unsafe float[] GetGlyphWidths(ReadOnlySpan<char> text, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphWidths(ReadOnlySpan<byte> text, SKTextEncoding encoding, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphWidths(IntPtr text, int length, SKTextEncoding encoding, SKPaint paint = null)
	{
	...
	{
		return GetGlyphWidths(MemoryExtensions.AsSpan(text), out bounds, paint);
	}

	public unsafe float[] GetGlyphWidths(ReadOnlySpan<char> text, out SKRect[] bounds, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphWidths(ReadOnlySpan<byte> text, SKTextEncoding encoding, out SKRect[] bounds, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe float[] GetGlyphWidths(IntPtr text, int length, SKTextEncoding encoding, out SKRect[] bounds, SKPaint paint = null)
	{
	...
	{
		GetGlyphWidths(MemoryExtensions.AsSpan(text), widths, bounds, paint);
	}

	public unsafe void GetGlyphWidths(ReadOnlySpan<char> text, Span<float> widths, Span<SKRect> bounds, SKPaint paint = null)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphWidths(ReadOnlySpan<byte> text, SKTextEncoding encoding, Span<float> widths, Span<SKRect> bounds, SKPaint paint = null)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe void GetGlyphWidths(IntPtr text, int length, SKTextEncoding encoding, Span<float> widths, Span<SKRect> bounds, SKPaint paint = null)
	{
	...
	public SKPath GetTextPath(string text, SKPoint origin = default(SKPoint))
	{
		return GetTextPath(MemoryExtensions.AsSpan(text), origin);
	}

	public unsafe SKPath GetTextPath(ReadOnlySpan<char> text, SKPoint origin = default(SKPoint))
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPath(ReadOnlySpan<byte> text, SKTextEncoding encoding, SKPoint origin = default(SKPoint))
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPath(IntPtr text, int length, SKTextEncoding encoding, SKPoint origin = default(SKPoint))
	{
	...
	{
		return GetTextPath(MemoryExtensions.AsSpan(text), positions);
	}

	public unsafe SKPath GetTextPath(ReadOnlySpan<char> text, ReadOnlySpan<SKPoint> positions)
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPath(ReadOnlySpan<byte> text, SKTextEncoding encoding, ReadOnlySpan<SKPoint> positions)
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPath(IntPtr text, int length, SKTextEncoding encoding, ReadOnlySpan<SKPoint> positions)
	{
	...
	{
		DelegateProxies.Create(glyphPathDelegate, out var gch, out var contextPtr);
		SKGlyphPathProxyDelegate glyphPathProc = ((glyphPathDelegate != null) ? DelegateProxies.SKGlyphPathProxy : null);
		try
		{
			fixed (ushort* glyphs2 = glyphs)
			{
	...
	public SKPath GetTextPathOnPath(string text, SKPath path, SKTextAlign textAlign = SKTextAlign.Left, SKPoint origin = default(SKPoint))
	{
		return GetTextPathOnPath(MemoryExtensions.AsSpan(text), path, textAlign, origin);
	}

	public unsafe SKPath GetTextPathOnPath(ReadOnlySpan<char> text, SKPath path, SKTextAlign textAlign = SKTextAlign.Left, SKPoint origin = default(SKPoint))
	{
		fixed (char* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPathOnPath(ReadOnlySpan<byte> text, SKTextEncoding encoding, SKPath path, SKTextAlign textAlign = SKTextAlign.Left, SKPoint origin = default(SKPoint))
	{
		fixed (byte* ptr = text)
		{
			void* text2 = ptr;
	...
	public unsafe SKPath GetTextPathOnPath(IntPtr text, int length, SKTextEncoding encoding, SKPath path, SKTextAlign textAlign = SKTextAlign.Left, SKPoint origin = default(SKPoint))
	{
	...
	public SKPath GetTextPathOnPath(ReadOnlySpan<ushort> glyphs, SKPath path, SKTextAlign textAlign = SKTextAlign.Left, SKPoint origin = default(SKPoint))
	{
		if (path == null)
		{
