...
public class XVTRForm : Form
{
	...
	private bool _ignore_combo_events;
	...
	public XVTRForm(Console c)
	{
		...
		console = c;
		SetupControlArrays();
		Common.RestoreForm(this, "XVTR", restore_size: false);
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Thetis.XVTRForm));
		...
		this.comboAnt15.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt15.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt14.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt14.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt13.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt13.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt12.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt12.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt11.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt11.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt10.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt10.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt9.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt9.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt8.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt8.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt7.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt7.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt6.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt6.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt5.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt5.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt4.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt4.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt3.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt3.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt2.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt2.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt1.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt1.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.comboAnt0.Items.AddRange(new object[4] { "def", "1", "2", "3" });
		...
		this.comboAnt0.SelectedIndexChanged += new System.EventHandler(comboAnt0_SelectedIndexChanged);
		...
		this.chkAlexTRRelay.CheckedChanged += new System.EventHandler(chkAlexTRRelay_CheckedChanged);
		...
		this.chkUseXVTRTUNPWR.CheckedChanged += new System.EventHandler(chkUseXVTRTUNPWR_CheckedChanged);
		this.udRXGain15.DecimalPlaces = 1;
		this.udRXGain15.Enabled = false;
		this.udRXGain15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain15.Location = new System.Drawing.Point(590, 408);
		this.udRXGain15.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain15.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain15.Value = new decimal(new int[4]);
		this.udRXGain15.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain14.DecimalPlaces = 1;
		this.udRXGain14.Enabled = false;
		this.udRXGain14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain14.Location = new System.Drawing.Point(590, 384);
		this.udRXGain14.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain14.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain14.Value = new decimal(new int[4]);
		this.udRXGain14.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain13.DecimalPlaces = 1;
		this.udRXGain13.Enabled = false;
		this.udRXGain13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain13.Location = new System.Drawing.Point(590, 360);
		this.udRXGain13.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain13.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain13.Value = new decimal(new int[4]);
		this.udRXGain13.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain12.DecimalPlaces = 1;
		this.udRXGain12.Enabled = false;
		this.udRXGain12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain12.Location = new System.Drawing.Point(590, 336);
		this.udRXGain12.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain12.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain12.Value = new decimal(new int[4]);
		this.udRXGain12.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain11.DecimalPlaces = 1;
		this.udRXGain11.Enabled = false;
		this.udRXGain11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain11.Location = new System.Drawing.Point(590, 312);
		this.udRXGain11.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain11.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain11.Value = new decimal(new int[4]);
		this.udRXGain11.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain10.DecimalPlaces = 1;
		this.udRXGain10.Enabled = false;
		this.udRXGain10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain10.Location = new System.Drawing.Point(590, 288);
		this.udRXGain10.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain10.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain10.Value = new decimal(new int[4]);
		this.udRXGain10.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain9.DecimalPlaces = 1;
		this.udRXGain9.Enabled = false;
		this.udRXGain9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain9.Location = new System.Drawing.Point(590, 264);
		this.udRXGain9.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain9.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain9.Value = new decimal(new int[4]);
		this.udRXGain9.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain8.DecimalPlaces = 1;
		this.udRXGain8.Enabled = false;
		this.udRXGain8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain8.Location = new System.Drawing.Point(590, 240);
		this.udRXGain8.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain8.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain8.Value = new decimal(new int[4]);
		this.udRXGain8.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain7.DecimalPlaces = 1;
		this.udRXGain7.Enabled = false;
		this.udRXGain7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain7.Location = new System.Drawing.Point(590, 216);
		this.udRXGain7.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain7.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain7.Value = new decimal(new int[4]);
		this.udRXGain7.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain6.DecimalPlaces = 1;
		this.udRXGain6.Enabled = false;
		this.udRXGain6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain6.Location = new System.Drawing.Point(590, 192);
		this.udRXGain6.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain6.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain6.Value = new decimal(new int[4]);
		this.udRXGain6.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain5.DecimalPlaces = 1;
		this.udRXGain5.Enabled = false;
		this.udRXGain5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain5.Location = new System.Drawing.Point(590, 168);
		this.udRXGain5.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain5.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain5.Value = new decimal(new int[4]);
		this.udRXGain5.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain4.DecimalPlaces = 1;
		this.udRXGain4.Enabled = false;
		this.udRXGain4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain4.Location = new System.Drawing.Point(590, 144);
		this.udRXGain4.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain4.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain4.Value = new decimal(new int[4]);
		this.udRXGain4.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain3.DecimalPlaces = 1;
		this.udRXGain3.Enabled = false;
		this.udRXGain3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain3.Location = new System.Drawing.Point(590, 120);
		this.udRXGain3.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain3.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain3.Value = new decimal(new int[4]);
		this.udRXGain3.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain2.DecimalPlaces = 1;
		this.udRXGain2.Enabled = false;
		this.udRXGain2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain2.Location = new System.Drawing.Point(590, 96);
		this.udRXGain2.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain2.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain2.Value = new decimal(new int[4]);
		this.udRXGain2.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain1.DecimalPlaces = 1;
		this.udRXGain1.Enabled = false;
		this.udRXGain1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain1.Location = new System.Drawing.Point(590, 72);
		this.udRXGain1.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain1.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain1.Value = new decimal(new int[4]);
		this.udRXGain1.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		this.udRXGain0.DecimalPlaces = 1;
		this.udRXGain0.Enabled = false;
		this.udRXGain0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udRXGain0.Location = new System.Drawing.Point(590, 48);
		this.udRXGain0.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udRXGain0.Minimum = new decimal(new int[4] { 100, 0, 0, -2147483648 });
		...
		this.udRXGain0.Value = new decimal(new int[4]);
		this.udRXGain0.ValueChanged += new System.EventHandler(udRXGain_ValueChanged);
		...
		this.chkXVTRRF15.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF14.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF13.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF12.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF11.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF10.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF9.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF8.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF7.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF6.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF5.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF4.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF3.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF2.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF1.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.chkXVTRRF0.CheckedChanged += new System.EventHandler(chkXVTRRF_CheckedChanged);
		...
		this.udPower15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower15.Location = new System.Drawing.Point(710, 408);
		this.udPower15.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower15.Minimum = new decimal(new int[4]);
		...
		this.udPower15.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower15.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower14.Enabled = false;
		this.udPower14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower14.Location = new System.Drawing.Point(710, 384);
		this.udPower14.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower14.Minimum = new decimal(new int[4]);
		...
		this.udPower14.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower14.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower13.Enabled = false;
		this.udPower13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower13.Location = new System.Drawing.Point(710, 360);
		this.udPower13.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower13.Minimum = new decimal(new int[4]);
		...
		this.udPower13.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower13.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower12.Enabled = false;
		this.udPower12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower12.Location = new System.Drawing.Point(710, 336);
		this.udPower12.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower12.Minimum = new decimal(new int[4]);
		...
		this.udPower12.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower12.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower11.Enabled = false;
		this.udPower11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower11.Location = new System.Drawing.Point(710, 312);
		this.udPower11.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower11.Minimum = new decimal(new int[4]);
		...
		this.udPower11.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower11.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower10.Enabled = false;
		this.udPower10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower10.Location = new System.Drawing.Point(710, 288);
		this.udPower10.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower10.Minimum = new decimal(new int[4]);
		...
		this.udPower10.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower10.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower9.Enabled = false;
		this.udPower9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower9.Location = new System.Drawing.Point(710, 264);
		this.udPower9.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower9.Minimum = new decimal(new int[4]);
		...
		this.udPower9.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower9.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower8.Enabled = false;
		this.udPower8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower8.Location = new System.Drawing.Point(710, 240);
		this.udPower8.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower8.Minimum = new decimal(new int[4]);
		...
		this.udPower8.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower8.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower7.Enabled = false;
		this.udPower7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower7.Location = new System.Drawing.Point(710, 216);
		this.udPower7.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower7.Minimum = new decimal(new int[4]);
		...
		this.udPower7.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower7.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower6.Enabled = false;
		this.udPower6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower6.Location = new System.Drawing.Point(710, 192);
		this.udPower6.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower6.Minimum = new decimal(new int[4]);
		...
		this.udPower6.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower6.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower5.Enabled = false;
		this.udPower5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower5.Location = new System.Drawing.Point(710, 168);
		this.udPower5.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower5.Minimum = new decimal(new int[4]);
		...
		this.udPower5.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower5.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower4.Enabled = false;
		this.udPower4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower4.Location = new System.Drawing.Point(710, 144);
		this.udPower4.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower4.Minimum = new decimal(new int[4]);
		...
		this.udPower4.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower4.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower3.Enabled = false;
		this.udPower3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower3.Location = new System.Drawing.Point(710, 120);
		this.udPower3.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower3.Minimum = new decimal(new int[4]);
		...
		this.udPower3.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower3.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower2.Enabled = false;
		this.udPower2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower2.Location = new System.Drawing.Point(710, 96);
		this.udPower2.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower2.Minimum = new decimal(new int[4]);
		...
		this.udPower2.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower2.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower1.Enabled = false;
		this.udPower1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower1.Location = new System.Drawing.Point(710, 72);
		this.udPower1.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower1.Minimum = new decimal(new int[4]);
		...
		this.udPower1.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower1.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		this.udPower0.Enabled = false;
		this.udPower0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udPower0.Location = new System.Drawing.Point(710, 48);
		this.udPower0.Maximum = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower0.Minimum = new decimal(new int[4]);
		...
		this.udPower0.Value = new decimal(new int[4] { 100, 0, 0, 0 });
		this.udPower0.ValueChanged += new System.EventHandler(udPower_ValueChanged);
		...
		this.udLOError15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError15.Location = new System.Drawing.Point(318, 408);
		this.udLOError15.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError15.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError15.Value = new decimal(new int[4]);
		this.udLOError14.DecimalPlaces = 3;
		this.udLOError14.Enabled = false;
		this.udLOError14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError14.Location = new System.Drawing.Point(318, 384);
		this.udLOError14.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError14.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError14.Value = new decimal(new int[4]);
		this.udLOError13.DecimalPlaces = 3;
		this.udLOError13.Enabled = false;
		this.udLOError13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError13.Location = new System.Drawing.Point(318, 360);
		this.udLOError13.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError13.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError13.Value = new decimal(new int[4]);
		this.udLOError12.DecimalPlaces = 3;
		this.udLOError12.Enabled = false;
		this.udLOError12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError12.Location = new System.Drawing.Point(318, 336);
		this.udLOError12.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError12.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError12.Value = new decimal(new int[4]);
		this.udLOError11.DecimalPlaces = 3;
		this.udLOError11.Enabled = false;
		this.udLOError11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError11.Location = new System.Drawing.Point(318, 312);
		this.udLOError11.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError11.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError11.Value = new decimal(new int[4]);
		this.udLOError10.DecimalPlaces = 3;
		this.udLOError10.Enabled = false;
		this.udLOError10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError10.Location = new System.Drawing.Point(318, 288);
		this.udLOError10.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError10.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError10.Value = new decimal(new int[4]);
		this.udLOError9.DecimalPlaces = 3;
		this.udLOError9.Enabled = false;
		this.udLOError9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError9.Location = new System.Drawing.Point(318, 264);
		this.udLOError9.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError9.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError9.Value = new decimal(new int[4]);
		this.udLOError8.DecimalPlaces = 3;
		this.udLOError8.Enabled = false;
		this.udLOError8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError8.Location = new System.Drawing.Point(318, 240);
		this.udLOError8.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError8.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError8.Value = new decimal(new int[4]);
		this.udLOError7.DecimalPlaces = 3;
		this.udLOError7.Enabled = false;
		this.udLOError7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError7.Location = new System.Drawing.Point(318, 216);
		this.udLOError7.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError7.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError7.Value = new decimal(new int[4]);
		this.udLOError6.DecimalPlaces = 3;
		this.udLOError6.Enabled = false;
		this.udLOError6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError6.Location = new System.Drawing.Point(318, 192);
		this.udLOError6.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError6.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError6.Value = new decimal(new int[4]);
		this.udLOError5.DecimalPlaces = 3;
		this.udLOError5.Enabled = false;
		this.udLOError5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError5.Location = new System.Drawing.Point(318, 168);
		this.udLOError5.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError5.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError5.Value = new decimal(new int[4]);
		this.udLOError4.DecimalPlaces = 3;
		this.udLOError4.Enabled = false;
		this.udLOError4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError4.Location = new System.Drawing.Point(318, 144);
		this.udLOError4.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError4.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError4.Value = new decimal(new int[4]);
		this.udLOError3.DecimalPlaces = 3;
		this.udLOError3.Enabled = false;
		this.udLOError3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError3.Location = new System.Drawing.Point(318, 120);
		this.udLOError3.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError3.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError3.Value = new decimal(new int[4]);
		this.udLOError2.DecimalPlaces = 3;
		this.udLOError2.Enabled = false;
		this.udLOError2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError2.Location = new System.Drawing.Point(318, 96);
		this.udLOError2.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError2.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError2.Value = new decimal(new int[4]);
		this.udLOError1.DecimalPlaces = 3;
		this.udLOError1.Enabled = false;
		this.udLOError1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError1.Location = new System.Drawing.Point(318, 72);
		this.udLOError1.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError1.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError1.Value = new decimal(new int[4]);
		this.udLOError0.DecimalPlaces = 3;
		this.udLOError0.Enabled = false;
		this.udLOError0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOError0.Location = new System.Drawing.Point(318, 48);
		this.udLOError0.Maximum = new decimal(new int[4] { 1000, 0, 0, 0 });
		this.udLOError0.Minimum = new decimal(new int[4] { 1000, 0, 0, -2147483648 });
		...
		this.udLOError0.Value = new decimal(new int[4]);
		...
		this.udFreqEnd15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd15.Location = new System.Drawing.Point(486, 408);
		this.udFreqEnd15.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd15.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd15.Value = new decimal(new int[4]);
		this.udFreqEnd14.DecimalPlaces = 6;
		this.udFreqEnd14.Enabled = false;
		this.udFreqEnd14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd14.Location = new System.Drawing.Point(486, 384);
		this.udFreqEnd14.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd14.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd14.Value = new decimal(new int[4]);
		this.udFreqEnd13.DecimalPlaces = 6;
		this.udFreqEnd13.Enabled = false;
		this.udFreqEnd13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd13.Location = new System.Drawing.Point(486, 360);
		this.udFreqEnd13.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd13.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd13.Value = new decimal(new int[4]);
		this.udFreqEnd12.DecimalPlaces = 6;
		this.udFreqEnd12.Enabled = false;
		this.udFreqEnd12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd12.Location = new System.Drawing.Point(486, 336);
		this.udFreqEnd12.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd12.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd12.Value = new decimal(new int[4]);
		this.udFreqEnd11.DecimalPlaces = 6;
		this.udFreqEnd11.Enabled = false;
		this.udFreqEnd11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd11.Location = new System.Drawing.Point(486, 312);
		this.udFreqEnd11.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd11.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd11.Value = new decimal(new int[4]);
		this.udFreqEnd10.DecimalPlaces = 6;
		this.udFreqEnd10.Enabled = false;
		this.udFreqEnd10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd10.Location = new System.Drawing.Point(486, 288);
		this.udFreqEnd10.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd10.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd10.Value = new decimal(new int[4]);
		this.udFreqEnd9.DecimalPlaces = 6;
		this.udFreqEnd9.Enabled = false;
		this.udFreqEnd9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd9.Location = new System.Drawing.Point(486, 264);
		this.udFreqEnd9.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd9.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd9.Value = new decimal(new int[4]);
		this.udFreqEnd8.DecimalPlaces = 6;
		this.udFreqEnd8.Enabled = false;
		this.udFreqEnd8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd8.Location = new System.Drawing.Point(486, 240);
		this.udFreqEnd8.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd8.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd8.Value = new decimal(new int[4]);
		this.udFreqEnd7.DecimalPlaces = 6;
		this.udFreqEnd7.Enabled = false;
		this.udFreqEnd7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd7.Location = new System.Drawing.Point(486, 216);
		this.udFreqEnd7.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd7.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd7.Value = new decimal(new int[4]);
		this.udFreqEnd6.DecimalPlaces = 6;
		this.udFreqEnd6.Enabled = false;
		this.udFreqEnd6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd6.Location = new System.Drawing.Point(486, 192);
		this.udFreqEnd6.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd6.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd6.Value = new decimal(new int[4]);
		this.udFreqEnd5.DecimalPlaces = 6;
		this.udFreqEnd5.Enabled = false;
		this.udFreqEnd5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd5.Location = new System.Drawing.Point(486, 168);
		this.udFreqEnd5.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd5.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd5.Value = new decimal(new int[4]);
		this.udFreqEnd4.DecimalPlaces = 6;
		this.udFreqEnd4.Enabled = false;
		this.udFreqEnd4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd4.Location = new System.Drawing.Point(486, 144);
		this.udFreqEnd4.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd4.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd4.Value = new decimal(new int[4]);
		this.udFreqEnd3.DecimalPlaces = 6;
		this.udFreqEnd3.Enabled = false;
		this.udFreqEnd3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd3.Location = new System.Drawing.Point(486, 120);
		this.udFreqEnd3.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd3.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd3.Value = new decimal(new int[4]);
		this.udFreqEnd2.DecimalPlaces = 6;
		this.udFreqEnd2.Enabled = false;
		this.udFreqEnd2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd2.Location = new System.Drawing.Point(486, 96);
		this.udFreqEnd2.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd2.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd2.Value = new decimal(new int[4]);
		this.udFreqEnd1.DecimalPlaces = 6;
		this.udFreqEnd1.Enabled = false;
		this.udFreqEnd1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd1.Location = new System.Drawing.Point(486, 72);
		this.udFreqEnd1.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd1.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd1.Value = new decimal(new int[4]);
		this.udFreqEnd0.DecimalPlaces = 6;
		this.udFreqEnd0.Enabled = false;
		this.udFreqEnd0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqEnd0.Location = new System.Drawing.Point(486, 48);
		this.udFreqEnd0.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqEnd0.Minimum = new decimal(new int[4]);
		...
		this.udFreqEnd0.Value = new decimal(new int[4]);
		...
		this.udFreqBegin15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin15.Location = new System.Drawing.Point(382, 408);
		this.udFreqBegin15.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin15.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin15.Value = new decimal(new int[4]);
		this.udFreqBegin14.DecimalPlaces = 6;
		this.udFreqBegin14.Enabled = false;
		this.udFreqBegin14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin14.Location = new System.Drawing.Point(382, 384);
		this.udFreqBegin14.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin14.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin14.Value = new decimal(new int[4]);
		this.udFreqBegin13.DecimalPlaces = 6;
		this.udFreqBegin13.Enabled = false;
		this.udFreqBegin13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin13.Location = new System.Drawing.Point(382, 360);
		this.udFreqBegin13.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin13.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin13.Value = new decimal(new int[4]);
		this.udFreqBegin12.DecimalPlaces = 6;
		this.udFreqBegin12.Enabled = false;
		this.udFreqBegin12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin12.Location = new System.Drawing.Point(382, 336);
		this.udFreqBegin12.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin12.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin12.Value = new decimal(new int[4]);
		this.udFreqBegin11.DecimalPlaces = 6;
		this.udFreqBegin11.Enabled = false;
		this.udFreqBegin11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin11.Location = new System.Drawing.Point(382, 312);
		this.udFreqBegin11.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin11.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin11.Value = new decimal(new int[4]);
		this.udFreqBegin10.DecimalPlaces = 6;
		this.udFreqBegin10.Enabled = false;
		this.udFreqBegin10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin10.Location = new System.Drawing.Point(382, 288);
		this.udFreqBegin10.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin10.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin10.Value = new decimal(new int[4]);
		this.udFreqBegin9.DecimalPlaces = 6;
		this.udFreqBegin9.Enabled = false;
		this.udFreqBegin9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin9.Location = new System.Drawing.Point(382, 264);
		this.udFreqBegin9.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin9.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin9.Value = new decimal(new int[4]);
		this.udFreqBegin8.DecimalPlaces = 6;
		this.udFreqBegin8.Enabled = false;
		this.udFreqBegin8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin8.Location = new System.Drawing.Point(382, 240);
		this.udFreqBegin8.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin8.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin8.Value = new decimal(new int[4]);
		this.udFreqBegin7.DecimalPlaces = 6;
		this.udFreqBegin7.Enabled = false;
		this.udFreqBegin7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin7.Location = new System.Drawing.Point(382, 216);
		this.udFreqBegin7.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin7.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin7.Value = new decimal(new int[4]);
		this.udFreqBegin6.DecimalPlaces = 6;
		this.udFreqBegin6.Enabled = false;
		this.udFreqBegin6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin6.Location = new System.Drawing.Point(382, 192);
		this.udFreqBegin6.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin6.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin6.Value = new decimal(new int[4]);
		this.udFreqBegin5.DecimalPlaces = 6;
		this.udFreqBegin5.Enabled = false;
		this.udFreqBegin5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin5.Location = new System.Drawing.Point(382, 168);
		this.udFreqBegin5.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin5.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin5.Value = new decimal(new int[4]);
		this.udFreqBegin4.DecimalPlaces = 6;
		this.udFreqBegin4.Enabled = false;
		this.udFreqBegin4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin4.Location = new System.Drawing.Point(382, 144);
		this.udFreqBegin4.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin4.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin4.Value = new decimal(new int[4]);
		this.udFreqBegin3.DecimalPlaces = 6;
		this.udFreqBegin3.Enabled = false;
		this.udFreqBegin3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin3.Location = new System.Drawing.Point(382, 120);
		this.udFreqBegin3.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin3.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin3.Value = new decimal(new int[4]);
		this.udFreqBegin2.DecimalPlaces = 6;
		this.udFreqBegin2.Enabled = false;
		this.udFreqBegin2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin2.Location = new System.Drawing.Point(382, 96);
		this.udFreqBegin2.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin2.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin2.Value = new decimal(new int[4]);
		this.udFreqBegin1.DecimalPlaces = 6;
		this.udFreqBegin1.Enabled = false;
		this.udFreqBegin1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin1.Location = new System.Drawing.Point(382, 72);
		this.udFreqBegin1.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin1.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin1.Value = new decimal(new int[4]);
		this.udFreqBegin0.DecimalPlaces = 6;
		this.udFreqBegin0.Enabled = false;
		this.udFreqBegin0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udFreqBegin0.Location = new System.Drawing.Point(382, 48);
		this.udFreqBegin0.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udFreqBegin0.Minimum = new decimal(new int[4]);
		...
		this.udFreqBegin0.Value = new decimal(new int[4]);
		...
		this.udLOOffset15.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset15.Location = new System.Drawing.Point(230, 408);
		this.udLOOffset15.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset15.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset15.Value = new decimal(new int[4]);
		this.udLOOffset14.DecimalPlaces = 1;
		this.udLOOffset14.Enabled = false;
		this.udLOOffset14.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset14.Location = new System.Drawing.Point(230, 384);
		this.udLOOffset14.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset14.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset14.Value = new decimal(new int[4]);
		this.udLOOffset13.DecimalPlaces = 1;
		this.udLOOffset13.Enabled = false;
		this.udLOOffset13.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset13.Location = new System.Drawing.Point(230, 360);
		this.udLOOffset13.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset13.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset13.Value = new decimal(new int[4]);
		this.udLOOffset12.DecimalPlaces = 1;
		this.udLOOffset12.Enabled = false;
		this.udLOOffset12.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset12.Location = new System.Drawing.Point(230, 336);
		this.udLOOffset12.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset12.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset12.Value = new decimal(new int[4]);
		this.udLOOffset11.DecimalPlaces = 1;
		this.udLOOffset11.Enabled = false;
		this.udLOOffset11.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset11.Location = new System.Drawing.Point(230, 312);
		this.udLOOffset11.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset11.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset11.Value = new decimal(new int[4]);
		this.udLOOffset10.DecimalPlaces = 1;
		this.udLOOffset10.Enabled = false;
		this.udLOOffset10.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset10.Location = new System.Drawing.Point(230, 288);
		this.udLOOffset10.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset10.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset10.Value = new decimal(new int[4]);
		this.udLOOffset9.DecimalPlaces = 1;
		this.udLOOffset9.Enabled = false;
		this.udLOOffset9.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset9.Location = new System.Drawing.Point(230, 264);
		this.udLOOffset9.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset9.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset9.Value = new decimal(new int[4]);
		this.udLOOffset8.DecimalPlaces = 1;
		this.udLOOffset8.Enabled = false;
		this.udLOOffset8.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset8.Location = new System.Drawing.Point(230, 240);
		this.udLOOffset8.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset8.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset8.Value = new decimal(new int[4]);
		this.udLOOffset7.DecimalPlaces = 1;
		this.udLOOffset7.Enabled = false;
		this.udLOOffset7.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset7.Location = new System.Drawing.Point(230, 216);
		this.udLOOffset7.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset7.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset7.Value = new decimal(new int[4]);
		this.udLOOffset6.DecimalPlaces = 1;
		this.udLOOffset6.Enabled = false;
		this.udLOOffset6.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset6.Location = new System.Drawing.Point(230, 192);
		this.udLOOffset6.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset6.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset6.Value = new decimal(new int[4]);
		this.udLOOffset5.DecimalPlaces = 1;
		this.udLOOffset5.Enabled = false;
		this.udLOOffset5.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset5.Location = new System.Drawing.Point(230, 168);
		this.udLOOffset5.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset5.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset5.Value = new decimal(new int[4]);
		this.udLOOffset4.DecimalPlaces = 1;
		this.udLOOffset4.Enabled = false;
		this.udLOOffset4.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset4.Location = new System.Drawing.Point(230, 144);
		this.udLOOffset4.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset4.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset4.Value = new decimal(new int[4]);
		this.udLOOffset3.DecimalPlaces = 1;
		this.udLOOffset3.Enabled = false;
		this.udLOOffset3.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset3.Location = new System.Drawing.Point(230, 120);
		this.udLOOffset3.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset3.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset3.Value = new decimal(new int[4]);
		this.udLOOffset2.DecimalPlaces = 1;
		this.udLOOffset2.Enabled = false;
		this.udLOOffset2.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset2.Location = new System.Drawing.Point(230, 96);
		this.udLOOffset2.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset2.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset2.Value = new decimal(new int[4]);
		this.udLOOffset1.DecimalPlaces = 1;
		this.udLOOffset1.Enabled = false;
		this.udLOOffset1.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset1.Location = new System.Drawing.Point(230, 72);
		this.udLOOffset1.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset1.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset1.Value = new decimal(new int[4]);
		this.udLOOffset0.DecimalPlaces = 1;
		this.udLOOffset0.Enabled = false;
		this.udLOOffset0.Increment = new decimal(new int[4] { 1, 0, 0, 0 });
		this.udLOOffset0.Location = new System.Drawing.Point(230, 48);
		this.udLOOffset0.Maximum = new decimal(new int[4] { 99000, 0, 0, 0 });
		this.udLOOffset0.Minimum = new decimal(new int[4] { 144, 0, 0, -2147483648 });
		...
		this.udLOOffset0.Value = new decimal(new int[4]);
		...
		this.txtButtonText15.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText14.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText13.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText12.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText11.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText10.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText9.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText8.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText7.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText6.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText5.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText4.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText3.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText2.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText1.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.txtButtonText0.TextChanged += new System.EventHandler(txtButtonText_TextChanged);
		...
		this.chkEnable15.CheckedChanged += new System.EventHandler(chkEnable15_CheckedChanged);
		...
		this.chkEnable14.CheckedChanged += new System.EventHandler(chkEnable14_CheckedChanged);
		...
		this.chkEnable13.CheckedChanged += new System.EventHandler(chkEnable13_CheckedChanged);
		...
		this.chkEnable12.CheckedChanged += new System.EventHandler(chkEnable12_CheckedChanged);
		...
		this.chkEnable11.CheckedChanged += new System.EventHandler(chkEnable11_CheckedChanged);
		...
		this.chkEnable10.CheckedChanged += new System.EventHandler(chkEnable10_CheckedChanged);
		...
		this.chkEnable9.CheckedChanged += new System.EventHandler(chkEnable9_CheckedChanged);
		...
		this.chkEnable8.CheckedChanged += new System.EventHandler(chkEnable8_CheckedChanged);
		...
		this.chkEnable7.CheckedChanged += new System.EventHandler(chkEnable7_CheckedChanged);
		...
		this.chkEnable6.CheckedChanged += new System.EventHandler(chkEnable6_CheckedChanged);
		...
		this.chkEnable5.CheckedChanged += new System.EventHandler(chkEnable5_CheckedChanged);
		...
		this.chkEnable4.CheckedChanged += new System.EventHandler(chkEnable4_CheckedChanged);
		...
		this.chkEnable3.CheckedChanged += new System.EventHandler(chkEnable3_CheckedChanged);
		...
		this.chkEnable2.CheckedChanged += new System.EventHandler(chkEnable2_CheckedChanged);
		...
		this.chkEnable1.CheckedChanged += new System.EventHandler(chkEnable1_CheckedChanged);
		...
		this.chkEnable0.CheckedChanged += new System.EventHandler(chkEnable0_CheckedChanged);
		...
		base.ClientSize = new System.Drawing.Size(904, 454);
		base.Controls.Add(this.comboAnt15);
		base.Controls.Add(this.comboAnt14);
		base.Controls.Add(this.comboAnt13);
		base.Controls.Add(this.comboAnt12);
		base.Controls.Add(this.comboAnt11);
		base.Controls.Add(this.comboAnt10);
		base.Controls.Add(this.comboAnt9);
		base.Controls.Add(this.comboAnt8);
		base.Controls.Add(this.comboAnt7);
		base.Controls.Add(this.comboAnt6);
		base.Controls.Add(this.comboAnt5);
		base.Controls.Add(this.comboAnt4);
		base.Controls.Add(this.comboAnt3);
		base.Controls.Add(this.comboAnt2);
		base.Controls.Add(this.comboAnt1);
		base.Controls.Add(this.comboAnt0);
		base.Controls.Add(this.chkDisablePA15);
		base.Controls.Add(this.chkDisablePA14);
		base.Controls.Add(this.chkDisablePA13);
		base.Controls.Add(this.chkDisablePA12);
		base.Controls.Add(this.chkDisablePA11);
		base.Controls.Add(this.chkDisablePA10);
		base.Controls.Add(this.chkDisablePA9);
		base.Controls.Add(this.chkDisablePA8);
		base.Controls.Add(this.chkDisablePA7);
		base.Controls.Add(this.chkDisablePA6);
		base.Controls.Add(this.chkDisablePA5);
		base.Controls.Add(this.chkDisablePA4);
		base.Controls.Add(this.chkDisablePA3);
		base.Controls.Add(this.chkDisablePA2);
		base.Controls.Add(this.chkDisablePA1);
		base.Controls.Add(this.chkDisablePA0);
		base.Controls.Add(this.lblDisablePA);
		base.Controls.Add(this.chkAlexTRRelay);
		base.Controls.Add(this.chkUseXVTRTUNPWR);
		base.Controls.Add(this.udRXGain15);
		base.Controls.Add(this.udRXGain14);
		base.Controls.Add(this.udRXGain13);
		base.Controls.Add(this.udRXGain12);
		base.Controls.Add(this.udRXGain11);
		base.Controls.Add(this.udRXGain10);
		base.Controls.Add(this.udRXGain9);
		base.Controls.Add(this.udRXGain8);
		base.Controls.Add(this.udRXGain7);
		base.Controls.Add(this.udRXGain6);
		base.Controls.Add(this.udRXGain5);
		base.Controls.Add(this.udRXGain4);
		base.Controls.Add(this.udRXGain3);
		base.Controls.Add(this.udRXGain2);
		base.Controls.Add(this.udRXGain1);
		base.Controls.Add(this.udRXGain0);
		base.Controls.Add(this.lblRXGain);
		base.Controls.Add(this.chkXVTRRF15);
		base.Controls.Add(this.chkXVTRRF14);
		base.Controls.Add(this.chkXVTRRF13);
		base.Controls.Add(this.chkXVTRRF12);
		base.Controls.Add(this.chkXVTRRF11);
		base.Controls.Add(this.chkXVTRRF10);
		base.Controls.Add(this.chkXVTRRF9);
		base.Controls.Add(this.chkXVTRRF8);
		base.Controls.Add(this.chkXVTRRF7);
		base.Controls.Add(this.chkXVTRRF6);
		base.Controls.Add(this.chkXVTRRF5);
		base.Controls.Add(this.chkXVTRRF4);
		base.Controls.Add(this.chkXVTRRF3);
		base.Controls.Add(this.chkXVTRRF2);
		base.Controls.Add(this.chkXVTRRF1);
		base.Controls.Add(this.chkXVTRRF0);
		base.Controls.Add(this.lblXVTRRF);
		base.Controls.Add(this.udPower15);
		base.Controls.Add(this.udPower14);
		base.Controls.Add(this.udPower13);
		base.Controls.Add(this.udPower12);
		base.Controls.Add(this.udPower11);
		base.Controls.Add(this.udPower10);
		base.Controls.Add(this.udPower9);
		base.Controls.Add(this.udPower8);
		base.Controls.Add(this.udPower7);
		base.Controls.Add(this.udPower6);
		base.Controls.Add(this.udPower5);
		base.Controls.Add(this.udPower4);
		base.Controls.Add(this.udPower3);
		base.Controls.Add(this.udPower2);
		base.Controls.Add(this.udPower1);
		base.Controls.Add(this.udPower0);
		base.Controls.Add(this.lblPower);
		base.Controls.Add(this.udLOError15);
		base.Controls.Add(this.udLOError14);
		base.Controls.Add(this.udLOError13);
		base.Controls.Add(this.udLOError12);
		base.Controls.Add(this.udLOError11);
		base.Controls.Add(this.udLOError10);
		base.Controls.Add(this.udLOError9);
		base.Controls.Add(this.udLOError8);
		base.Controls.Add(this.udLOError7);
		base.Controls.Add(this.udLOError6);
		base.Controls.Add(this.udLOError5);
		base.Controls.Add(this.udLOError4);
		base.Controls.Add(this.udLOError3);
		base.Controls.Add(this.udLOError2);
		base.Controls.Add(this.udLOError1);
		base.Controls.Add(this.udLOError0);
		base.Controls.Add(this.lblLOError);
		base.Controls.Add(this.chkRXOnly15);
		base.Controls.Add(this.chkRXOnly14);
		base.Controls.Add(this.chkRXOnly13);
		base.Controls.Add(this.chkRXOnly12);
		base.Controls.Add(this.chkRXOnly11);
		base.Controls.Add(this.chkRXOnly10);
		base.Controls.Add(this.chkRXOnly9);
		base.Controls.Add(this.chkRXOnly8);
		base.Controls.Add(this.chkRXOnly7);
		base.Controls.Add(this.chkRXOnly6);
		base.Controls.Add(this.chkRXOnly5);
		base.Controls.Add(this.chkRXOnly4);
		base.Controls.Add(this.chkRXOnly3);
		base.Controls.Add(this.chkRXOnly2);
		base.Controls.Add(this.chkRXOnly1);
		base.Controls.Add(this.chkRXOnly0);
		base.Controls.Add(this.lblRXOnly);
		base.Controls.Add(this.udFreqEnd15);
		base.Controls.Add(this.udFreqEnd14);
		base.Controls.Add(this.udFreqEnd13);
		base.Controls.Add(this.udFreqEnd12);
		base.Controls.Add(this.udFreqEnd11);
		base.Controls.Add(this.udFreqEnd10);
		base.Controls.Add(this.udFreqEnd9);
		base.Controls.Add(this.udFreqEnd8);
		base.Controls.Add(this.udFreqEnd7);
		base.Controls.Add(this.udFreqEnd6);
		base.Controls.Add(this.udFreqEnd5);
		base.Controls.Add(this.udFreqEnd4);
		base.Controls.Add(this.udFreqEnd3);
		base.Controls.Add(this.udFreqEnd2);
		base.Controls.Add(this.udFreqEnd1);
		base.Controls.Add(this.udFreqEnd0);
		base.Controls.Add(this.lblFreqEnd);
		base.Controls.Add(this.udFreqBegin15);
		base.Controls.Add(this.udFreqBegin14);
		base.Controls.Add(this.udFreqBegin13);
		base.Controls.Add(this.udFreqBegin12);
		base.Controls.Add(this.udFreqBegin11);
		base.Controls.Add(this.udFreqBegin10);
		base.Controls.Add(this.udFreqBegin9);
		base.Controls.Add(this.udFreqBegin8);
		base.Controls.Add(this.udFreqBegin7);
		base.Controls.Add(this.udFreqBegin6);
		base.Controls.Add(this.udFreqBegin5);
		base.Controls.Add(this.udFreqBegin4);
		base.Controls.Add(this.udFreqBegin3);
		base.Controls.Add(this.udFreqBegin2);
		base.Controls.Add(this.udFreqBegin1);
		base.Controls.Add(this.udFreqBegin0);
		base.Controls.Add(this.lblFreqBegin);
		base.Controls.Add(this.udLOOffset15);
		base.Controls.Add(this.udLOOffset14);
		base.Controls.Add(this.udLOOffset13);
		base.Controls.Add(this.udLOOffset12);
		base.Controls.Add(this.udLOOffset11);
		base.Controls.Add(this.udLOOffset10);
		base.Controls.Add(this.udLOOffset9);
		base.Controls.Add(this.udLOOffset8);
		base.Controls.Add(this.udLOOffset7);
		base.Controls.Add(this.udLOOffset6);
		base.Controls.Add(this.udLOOffset5);
		base.Controls.Add(this.udLOOffset4);
		base.Controls.Add(this.udLOOffset3);
		base.Controls.Add(this.udLOOffset2);
		base.Controls.Add(this.udLOOffset1);
		base.Controls.Add(this.udLOOffset0);
		base.Controls.Add(this.lblLOOffset);
		base.Controls.Add(this.txtButtonText15);
		base.Controls.Add(this.txtButtonText14);
		base.Controls.Add(this.txtButtonText13);
		base.Controls.Add(this.txtButtonText12);
		base.Controls.Add(this.txtButtonText11);
		base.Controls.Add(this.txtButtonText10);
		base.Controls.Add(this.txtButtonText9);
		base.Controls.Add(this.txtButtonText8);
		base.Controls.Add(this.txtButtonText7);
		base.Controls.Add(this.txtButtonText6);
		base.Controls.Add(this.txtButtonText5);
		base.Controls.Add(this.txtButtonText4);
		base.Controls.Add(this.txtButtonText3);
		base.Controls.Add(this.txtButtonText2);
		base.Controls.Add(this.txtButtonText1);
		base.Controls.Add(this.txtButtonText0);
		base.Controls.Add(this.txtBandButton15);
		base.Controls.Add(this.txtBandButton14);
		base.Controls.Add(this.txtBandButton13);
		base.Controls.Add(this.txtBandButton12);
		base.Controls.Add(this.txtBandButton11);
		base.Controls.Add(this.txtBandButton10);
		base.Controls.Add(this.txtBandButton9);
		base.Controls.Add(this.txtBandButton8);
		base.Controls.Add(this.txtBandButton7);
		base.Controls.Add(this.txtBandButton6);
		base.Controls.Add(this.txtBandButton5);
		base.Controls.Add(this.txtBandButton4);
		base.Controls.Add(this.txtBandButton3);
		base.Controls.Add(this.txtBandButton2);
		base.Controls.Add(this.txtBandButton1);
		base.Controls.Add(this.txtBandButton0);
		base.Controls.Add(this.lblEnabled);
		base.Controls.Add(this.chkEnable15);
		base.Controls.Add(this.chkEnable14);
		base.Controls.Add(this.chkEnable13);
		base.Controls.Add(this.chkEnable12);
		base.Controls.Add(this.chkEnable11);
		base.Controls.Add(this.chkEnable10);
		base.Controls.Add(this.chkEnable9);
		base.Controls.Add(this.chkEnable8);
		base.Controls.Add(this.chkEnable7);
		base.Controls.Add(this.chkEnable6);
		base.Controls.Add(this.chkEnable5);
		base.Controls.Add(this.chkEnable4);
		base.Controls.Add(this.chkEnable3);
		base.Controls.Add(this.chkEnable2);
		base.Controls.Add(this.chkEnable1);
		base.Controls.Add(this.chkEnable0);
		base.Controls.Add(this.lblButtonText);
		base.Controls.Add(this.lblBandButton);
		base.Controls.Add(this.labelTS1);
		base.Icon = (System.Drawing.Icon)resources.GetObject("$this.Icon");
		base.Name = "XVTRForm";
		this.Text = "XVTR Setup";
		base.Closing += new System.ComponentModel.CancelEventHandler(XVTRForm_Closing);
	...
	public int XVTRFreq(double freq)
	{
		for (int i = 0; i < 16; i++)
		{
			if (enabled[i].Checked && freq >= (double)begin[i].Value && freq <= (double)end[i].Value)
			{
				return i;
			}
		}
	...
	public double TranslateFreq(double freq)
	{
		for (int i = 0; i < 16; i++)
		{
			if (enabled[i].Checked && freq >= (double)begin[i].Value && freq <= (double)end[i].Value)
			{
				return freq - (double)lo_offset[i].Value + (double)lo_error[i].Value / 1000.0;
			}
		}
		return freq;
	}
	...
	private void SetupControlArrays()
	{
		...
		CheckBox[] array = new CheckBoxTS[16];
		disable_pa = array;
	...
	{
		if (index < 0 || index > rx_antennas.Length - 1)
		{
			return 0;
		}
		if (rx_antennas[index].SelectedIndex == 0)
		{
			return 0;
		}
		return rx_antennas[index].SelectedIndex;
	}
	...
	{
		return 0f - (float)rx_gain[index].Value;
	}
	...
	private void XVTRForm_Closing(object sender, CancelEventArgs e)
	{
		Hide();
		e.Cancel = true;
	...
	{
		bool flag = chkEnable14.Checked;
		txtButtonText14.Enabled = flag;
		udLOOffset14.Enabled = flag;
		udLOError14.Enabled = flag;
		udFreqBegin14.Enabled = flag;
		udFreqEnd14.Enabled = flag;
		udRXGain14.Enabled = flag;
		chkRXOnly14.Enabled = flag;
		udPower14.Enabled = flag;
		chkXVTRRF14.Enabled = flag;
		chkDisablePA14.Enabled = flag;
		comboAnt14.Enabled = flag;
	}

	private void chkEnable15_CheckedChanged(object sender, EventArgs e)
	{
		bool flag = chkEnable15.Checked;
		txtButtonText15.Enabled = flag;
		udLOOffset15.Enabled = flag;
		udLOError15.Enabled = flag;
		udFreqBegin15.Enabled = flag;
		udFreqEnd15.Enabled = flag;
		udRXGain15.Enabled = flag;
		chkRXOnly15.Enabled = flag;
		udPower15.Enabled = flag;
		chkXVTRRF15.Enabled = flag;
		chkDisablePA15.Enabled = flag;
		comboAnt15.Enabled = flag;
	}

	private void txtButtonText_TextChanged(object sender, EventArgs e)
	{
		int index = int.Parse(((Control)sender).Name.Substring(13));
		console.SetVHFText(index, ((TextBoxTS)sender).Text);
	}
	...
	{
		int num = int.Parse(((Control)sender).Name.Substring(9));
		if (console.RX1XVTRIndex == num)
		{
			console.RX1XVTRIndex = -1;
			console.VFOAFreq = console.VFOAFreq;
		}
		if (console.RX2XVTRIndex == num)
		{
			console.RX2XVTRIndex = -1;
			console.VFOBFreq = console.VFOBFreq;
		}
		if (console.TXXVTRIndex == num)
		{
			console.TXXVTRIndex = -1;
	...
	{
		int num = int.Parse(((Control)sender).Name.Substring(8));
		if (console.RX1XVTRIndex == num)
		{
			console.RX1XVTRIndex = -1;
			console.VFOAFreq = console.VFOAFreq;
	...
	{
		int num = int.Parse(((Control)sender).Name.Substring(7));
		console.SetPower((Band)(14 + num), (int)((NumericUpDownTS)sender).Value);
	}

	private void comboAnt0_SelectedIndexChanged(object sender, EventArgs e)
	{
		if (!_ignore_combo_events)
		{
			int num = int.Parse(((Control)sender).Name.Substring(8));
			if (console.RX1XVTRIndex == num)
			{
