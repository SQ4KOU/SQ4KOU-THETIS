...
public class SliderSettingsForm : Form
{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Thetis.SliderSettingsForm));
		...
		this.tbMicGain.Scroll += new System.EventHandler(TbMicGain_Scroll);
		...
		this.chkSubRX.CheckedChanged += new System.EventHandler(chkSubRX_CheckedChanged);
		...
		this.tbSubRXPan.Scroll += new System.EventHandler(tbSubRXPan_Scroll);
		...
		this.tbSubRXAF.Scroll += new System.EventHandler(tbSubRXAF_Scroll);
		...
		this.tbDrive.Scroll += new System.EventHandler(tbDrive_Scroll);
		...
		this.chkRX2VAC.CheckedChanged += new System.EventHandler(ChkRX2VAC_CheckedChanged);
		...
		this.tbRX2VACTX.Scroll += new System.EventHandler(TbRX2VACTX_Scroll);
		...
		this.tbRX2VACRX.Scroll += new System.EventHandler(TbRX2VACRX_Scroll);
		...
		this.tbRX2Atten.Scroll += new System.EventHandler(tbRX2Atten_Scroll);
		...
		this.chkRX2Mute.CheckedChanged += new System.EventHandler(chkRX2Mute_CheckedChanged);
		...
		this.chkRX2Sql.CheckStateChanged += new System.EventHandler(chkRX2Sql_CheckStateChanged);
		...
		this.tbRX2Pan.Scroll += new System.EventHandler(tbRX2Pan_Scroll);
		...
		this.tbRX2Sql.Scroll += new System.EventHandler(tbRX2Sql_Scroll);
		...
		this.tbRX2RF.Scroll += new System.EventHandler(tbRX2RF_Scroll);
		...
		this.tbRX2AF.Scroll += new System.EventHandler(tbRX2AF_Scroll);
		...
		this.tbMasterAF.Scroll += new System.EventHandler(tbMasterAF_Scroll);
		...
		this.chkRX1VAC.CheckedChanged += new System.EventHandler(ChkRX1VAC_CheckedChanged);
		...
		this.tbRX1VACTX.Scroll += new System.EventHandler(TbRX1VACTX_Scroll);
		...
		this.tbRX1VACRX.Scroll += new System.EventHandler(TbRX1VACRX_Scroll);
		...
		this.tbRX1Atten.Scroll += new System.EventHandler(tbRX1Atten_Scroll);
		...
		this.chkRX1Mute.CheckedChanged += new System.EventHandler(chkRX1Mute_CheckedChanged);
		...
		this.chkRX1Sql.CheckStateChanged += new System.EventHandler(chkRX1Sql_CheckStateChanged);
		...
		this.tbRX1Pan.Scroll += new System.EventHandler(tbRX1Pan_Scroll);
		...
		this.tbRX1Sql.Scroll += new System.EventHandler(tbRX1Sql_Scroll);
		...
		this.tbRX1RF.Scroll += new System.EventHandler(tbRX1RF_Scroll);
		...
		this.tbRX1AF.Scroll += new System.EventHandler(tbRX1AF_Scroll);
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		this.BackColor = System.Drawing.Color.FromArgb(80, 80, 80);
		base.ClientSize = new System.Drawing.Size(883, 257);
		base.Controls.Add(this.labelTS16);
		base.Controls.Add(this.tbMicGain);
		base.Controls.Add(this.btnClose);
		base.Controls.Add(this.lblMasterAF);
		base.Controls.Add(this.lblDrive);
		base.Controls.Add(this.grpSubRX);
		base.Controls.Add(this.tbDrive);
		base.Controls.Add(this.grpRX2);
		base.Controls.Add(this.tbMasterAF);
		base.Controls.Add(this.grpRX1);
		base.Icon = (System.Drawing.Icon)resources.GetObject("$this.Icon");
		base.MaximizeBox = false;
		base.MinimizeBox = false;
		base.Name = "SliderSettingsForm";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Analogue Gain Control Settings";
		base.TopMost = true;
		base.Activated += new System.EventHandler(SliderSettingsForm_Activated);
		base.Closing += new System.ComponentModel.CancelEventHandler(SliderSettingsForm_Closing);
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(SliderSettingsForm_FormClosing);
	...
	private void SliderSettingsForm_Closing(object sender, CancelEventArgs e)
	{
		Hide();
		e.Cancel = true;
	...
	private void SliderSettingsForm_Activated(object sender, EventArgs e)
	{
		...
		if (console.SetupForm.ATTOnRX2 <= tbRX2Atten.Maximum)
		{
			tbRX2Atten.Value = console.SetupForm.ATTOnRX2;
		}
		else
		{
			tbRX2Atten.Value = tbRX2Atten.Maximum;
	...
	{
		if (console.RF != tbRX1RF.Value && console.AutoAGCRX1)
		{
	...
	{
		if (console.RX2RF != tbRX2RF.Value && console.AutoAGCRX2)
		{
	...
	{
		console.SetupForm.ATTOnRX2 = tbRX2Atten.Value;
	}
