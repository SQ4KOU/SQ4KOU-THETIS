...
public class UI
{
	...
	public static void CallControlInvalidate(Control c, object[] obj)
	{
		...
		{
			if (obj[0].GetType() == typeof(Rectangle) && obj[1].GetType() == typeof(bool))
			{
				c.Invalidate((Rectangle)obj[0], (bool)obj[1]);
			}
			else if (obj[0].GetType() == typeof(Region) && obj[1].GetType() == typeof(bool))
			{
	...
	{
		return c.SelectNextControl((Control)obj[0], (bool)obj[1], (bool)obj[2], (bool)obj[3], (bool)obj[4]);
	}
	...
	public static void CallControlSetBounds(Control c, object[] obj)
	{
		...
		if (obj.Length == 5)
		{
			c.SetBounds((int)obj[0], (int)obj[1], (int)obj[2], (int)obj[3], (BoundsSpecified)obj[4]);
		}
	}
