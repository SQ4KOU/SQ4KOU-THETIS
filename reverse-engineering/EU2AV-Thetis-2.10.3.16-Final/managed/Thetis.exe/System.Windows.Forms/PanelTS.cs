...
public class PanelTS : Panel
{
	...
	public new BorderStyle BorderStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetPanelBorderStyle), this, value);
			}
			else
			{
	...
	public new bool TabStop
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetPanelTabStop), this, value);
			}
			else
			{
				base.TabStop = value;
	...
	public new string Text
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetPanelText), this, value);
			}
			else
			{
				base.Text = value;
