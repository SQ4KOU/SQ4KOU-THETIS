...
public class NumericUpDownTS : NumericUpDown
{
	...
	public new virtual Control ActiveControl
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetContainerControlActiveControl), this, value);
			}
			else
			{
	...
	public new virtual bool AutoScroll
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetScrollableControlAutoScroll), this, value);
			}
			else
			{
	...
	public new Size AutoScrollMargin
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetScrollableControlAutoScrollMargin), this, value);
			}
			else
			{
	...
	public new Size AutoScrollMinSize
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetScrollableControlAutoScrollMinSize), this, value);
			}
			else
			{
	...
	public new Point AutoScrollPosition
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetScrollableControlAutoScrollPosition), this, value);
			}
			else
			{
	...
	public new BorderStyle BorderStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetUpDownBaseBorderStyle), this, value);
			}
			else
			{
	...
	public new int DecimalPlaces
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownDecimalPlaces), this, value);
			}
			else
			{
	...
	public new bool Hexadecimal
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownHexadecimal), this, value);
			}
			else
			{
	...
	public new decimal Increment
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownIncrement), this, value);
			}
			else
			{
	...
	public new bool InterceptArrowKeys
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetUpDownBaseInterceptArrowKeys), this, value);
			}
			else
			{
				base.InterceptArrowKeys = value;
			}
		}
	}
	...
	public new decimal Maximum
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownMaximum), this, value);
			}
			else
			{
				base.Maximum = value;
	...
	public new decimal Minimum
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownMinimum), this, value);
			}
			else
			{
				base.Minimum = value;
	...
	public new bool ReadOnly
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetUpDownBaseReadOnly), this, value);
			}
			else
			{
				base.ReadOnly = value;
	...
	public new string Text
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownText), this, value);
			}
			else
			{
				base.Text = value;
	...
	public new virtual HorizontalAlignment TextAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetUpDownBaseTextAlign), this, value);
			}
			else
			{
	...
	public new bool ThousandsSeparator
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownThousandsSeparator), this, value);
			}
			else
			{
	...
	public new LeftRightAlignment UpDownAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetUpDownBaseUpDownAlign), this, value);
			}
			else
			{
	...
	public new decimal Value
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetNumericUpDownValue), this, value);
			}
			else
			{
				base.Value = value;
	...
	public override void DownButton()
	{
		if (base.InvokeRequired)
		{
			Invoke(new MethodInvoker(base.DownButton));
		}
		else
		{
			base.DownButton();
	...
	public new void ScrollControlIntoView(Control activeControl)
	{
		if (base.InvokeRequired)
		{
			Invoke(new UI.CtrlVoidFunc(UI.CallScrollableControlScrollControlIntoView), this, new object[1] { activeControl });
		}
		else
		{
	...
	public new void Select(int start, int length)
	{
		if (base.InvokeRequired)
		{
			Invoke(new UI.CtrlVoidFunc(UI.CallUpDownBaseSelect), this, new object[2] { start, length });
		}
		else
		{
	...
	public new void SetAutoScrollMargin(int x, int y)
	{
		if (base.InvokeRequired)
		{
			Invoke(new UI.CtrlVoidFunc(UI.CallScrollableControlSetAutoScrollMargin), this, new object[2] { x, y });
		}
		else
		{
	...
	public override void UpButton()
	{
		if (base.InvokeRequired)
		{
			Invoke(new MethodInvoker(base.UpButton));
		}
		else
		{
			base.UpButton();
	...
	public new bool Validate()
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallContainerControlValidate), this, new object[0]);
			return (bool)EndInvoke(asyncResult);
		}
	...
	protected override void OnMouseWheel(MouseEventArgs e)
	{
		...
		if (DecimalPlaces > 0 && _tinyStep && num != 0.1m)
		{
			num = 0.1m;
		}
		if (e.Delta > 0)
