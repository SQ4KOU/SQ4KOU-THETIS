...
public class CheckBoxTS : CheckBox
{
	...
	public new Appearance Appearance
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxAppearance), this, value);
			}
			else
			{
	...
	public new bool AutoCheck
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxAutoCheck), this, value);
			}
			else
			{
	...
	public new ContentAlignment CheckAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxCheckAlign), this, value);
			}
			else
			{
	...
	public new bool Checked
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxChecked), this, value);
			}
			else
			{
				base.Checked = value;
	...
	public new CheckState CheckState
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxCheckState), this, value);
			}
			else
			{
	...
	public new bool ThreeState
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetCheckBoxThreeState), this, value);
			}
			else
			{
