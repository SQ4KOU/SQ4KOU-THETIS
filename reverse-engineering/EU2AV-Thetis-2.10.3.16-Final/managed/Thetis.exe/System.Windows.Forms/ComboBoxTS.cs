...
public class ComboBoxTS : ComboBox
{
	...
	public new Color BackColor
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxBackColor), this, value);
			}
			else
			{
	...
	public new object DataSource
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetListControlDataSource), this, value);
			}
			else
			{
	...
	public new string DisplayMember
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetListControlDisplayMember), this, value);
			}
			else
			{
	...
	public new DrawMode DrawMode
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxDrawMode), this, value);
			}
			else
			{
				base.DrawMode = value;
	...
	public new ComboBoxStyle DropDownStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxDropDownStyle), this, value);
			}
			else
			{
	...
	public new int DropDownWidth
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxDropDownWidth), this, value);
			}
			else
			{
	...
	public new bool DroppedDown
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxDroppedDown), this, value);
			}
			else
			{
	...
	public new Color ForeColor
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxForeColor), this, value);
			}
			else
			{
	...
	public new bool IntegralHeight
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxIntegralHeight), this, value);
			}
			else
			{
	...
	public new int MaxDropDownItems
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxMaxDropDownItems), this, value);
			}
			else
			{
	...
	public new int MaxLength
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxMaxLength), this, value);
			}
			else
			{
	...
	public new int SelectedIndex
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSelectedIndex), this, value);
			}
			else
			{
	...
	public new object SelectedItem
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSelectedItem), this, value);
			}
			else
			{
	...
	public new virtual string SelectedText
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSelectedText), this, value);
			}
			else
			{
	...
	public new object SelectedValue
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetListControlSelectedValue), this, value);
			}
			else
			{
	...
	public new int SelectionLength
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSelectionLength), this, value);
			}
			else
			{
	...
	public new int SelectionStart
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSelectionStart), this, value);
			}
			else
			{
	...
	public new bool Sorted
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxSorted), this, value);
			}
			else
			{
				base.Sorted = value;
	...
	public new string Text
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxText), this, value);
			}
			else
			{
				base.Text = value;
	...
	public new string ValueMember
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetComboBoxValueMember), this, value);
			}
			else
			{
	...
	public new void BeginUpdate()
	{
		if (base.InvokeRequired)
		{
			Invoke(new MethodInvoker(base.BeginUpdate));
		}
		else
		{
			base.BeginUpdate();
	...
	public new void EndUpdate()
	{
		if (base.InvokeRequired)
		{
			Invoke(new MethodInvoker(base.EndUpdate));
		}
		else
		{
			base.EndUpdate();
	...
	public new int FindString(string s)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallComboBoxFindString), this, new object[1] { s });
	...
	public new int FindString(string s, int startIndex)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallComboBoxFindString), this, new object[2] { s, startIndex });
			return (int)EndInvoke(asyncResult);
		}
		return base.FindString(s, startIndex);
	}
	...
	public new int FindStringExact(string s)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallComboBoxFindStringExact), this, new object[1] { s });
			return (int)EndInvoke(asyncResult);
		}
		return base.FindStringExact(s);
	}
	...
	public new int FindStringExact(string s, int startIndex)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallComboBoxFindStringExact), this, new object[2] { s, startIndex });
			return (int)EndInvoke(asyncResult);
		}
		return base.FindStringExact(s, startIndex);
	}
	...
	public new int GetItemHeight(int index)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallComboBoxGetItemHeight), this, new object[1] { index });
			return (int)EndInvoke(asyncResult);
		}
	...
	public new string GetItemText(object item)
	{
		if (base.InvokeRequired)
		{
			IAsyncResult asyncResult = BeginInvoke(new UI.CtrlRetFunc(UI.CallListControlGetItemText), this, new object[1] { item });
