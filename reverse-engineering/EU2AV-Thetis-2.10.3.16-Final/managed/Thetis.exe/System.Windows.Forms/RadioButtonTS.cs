...
public class RadioButtonTS : RadioButton
{
	...
	public new Appearance Appearance
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetRadioButtonAppearance), this, value);
			}
			else
			{
	...
	public new bool AutoCheck
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetRadioButtonAutoCheck), this, value);
			}
			else
			{
	...
	public new ContentAlignment CheckAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetRadioButtonCheckAlign), this, value);
			}
			else
			{
	...
	public new bool Checked
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetRadioButtonChecked), this, value);
			}
			else
			{
				base.Checked = value;
	...
	public override ContentAlignment TextAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetRadioButtonTextAlign), this, value);
			}
			else
			{
