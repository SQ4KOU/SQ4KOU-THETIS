...
public class TrackBarTS : TrackBar
{
	...
	public new bool AutoSize
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarAutoSize), this, value);
			}
			base.AutoSize = value;
		}
	}
	...
	public new int LargeChange
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarLargeChange), this, value);
			}
			else
			{
	...
	public new int Maximum
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarMaximum), this, value);
			}
			else
			{
				base.Maximum = value;
	...
	public new int Minimum
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarMinimum), this, value);
			}
			else
			{
				base.Minimum = value;
	...
	public new Orientation Orientation
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarOrientation), this, value);
			}
			else
			{
	...
	public new int SmallChange
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarSmallChange), this, value);
			}
			else
			{
	...
	public new int TickFrequency
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarTickFrequency), this, value);
			}
			else
			{
	...
	public new TickStyle TickStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarTickStyle), this, value);
			}
			else
			{
	...
	public new int Value
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetTrackBarValue), this, value);
			}
			else
			{
				base.Value = value;
	...
	public new void SetRange(int minValue, int maxValue)
	{
		if (base.InvokeRequired)
		{
			Invoke(new UI.CtrlVoidFunc(UI.CallTrackBarSetRange), this, new object[2] { minValue, maxValue });
		}
		else
		{
			base.SetRange(minValue, maxValue);
		}
	}
