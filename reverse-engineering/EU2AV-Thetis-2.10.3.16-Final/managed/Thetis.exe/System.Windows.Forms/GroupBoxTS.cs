...
public class GroupBoxTS : GroupBox
{
	...
	public new bool AllowDrop
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetGroupBoxAllowDrop), this, value);
			}
			else
			{
	...
	public new FlatStyle FlatStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetGroupBoxFlatStyle), this, value);
			}
			else
			{
	...
	public new string Text
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetGroupBoxText), this, value);
			}
			else
			{
				base.Text = value;
