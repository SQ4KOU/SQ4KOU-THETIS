...
public class LabelTS : Label
{
	...
	public new virtual bool AutoSize
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelAutoSize), this, value);
			}
			else
			{
				base.AutoSize = value;
	...
	public new BorderStyle BorderStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelBorderStyle), this, value);
			}
			else
			{
	...
	public new FlatStyle FlatStyle
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelFlatStyle), this, value);
			}
			else
			{
	...
	public new Image Image
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelImage), this, value);
			}
			else
			{
				base.Image = value;
	...
	public new ContentAlignment ImageAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelImageAlign), this, value);
			}
			else
			{
	...
	public new int ImageIndex
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelImageIndex), this, value);
			}
			else
			{
	...
	public new ImageList ImageList
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelImageList), this, value);
			}
			else
			{
	...
	public new string Text
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelText), this, value);
			}
			else
			{
				base.Text = value;
	...
	public new virtual ContentAlignment TextAlign
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelTextAlign), this, value);
			}
			else
			{
	...
	public new bool UseMnemonic
	{
		...
		set
		{
			if (base.InvokeRequired)
			{
				Invoke(new UI.SetCtrlDel(UI.SetLabelUseMnemonic), this, value);
			}
			else
			{
