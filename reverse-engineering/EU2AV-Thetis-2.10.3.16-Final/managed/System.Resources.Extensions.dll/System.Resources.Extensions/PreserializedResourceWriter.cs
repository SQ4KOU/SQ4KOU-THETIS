...
public sealed class PreserializedResourceWriter : IResourceWriter, IDisposable
{
	...
	{
		System.ExceptionPolyfills.ThrowIfNull(fileName, "fileName");
	...
	{
		System.ExceptionPolyfills.ThrowIfNull(name, "name");
	...
	private static void WriteValue(System.Resources.ResourceTypeCode typeCode, object value, BinaryWriter writer)
	{
		...
		case System.Resources.ResourceTypeCode.Stream:
		{
			...
			{
				MemoryStream obj = (MemoryStream)streamWrapper.Stream;
	...
	public void AddResource(string name, string value, string typeName)
	{
		...
		System.ExceptionPolyfills.ThrowIfNull(typeName, "typeName");
		if (s_primitiveTypes.TryGetValue(typeName, out var value2))
		{
			...
			object value3 = (TypeDescriptor.GetConverter(value2) ?? throw new TypeLoadException(System.SR.Format(System.SR.TypeLoadException_CannotLoadConverter, value2))).ConvertFromInvariantString(value);
