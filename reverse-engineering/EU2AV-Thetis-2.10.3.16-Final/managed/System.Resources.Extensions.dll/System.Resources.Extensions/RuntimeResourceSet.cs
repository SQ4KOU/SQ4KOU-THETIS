...
internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
{
	...
	{
		System.ExceptionPolyfills.ThrowIfNull(reader, "reader");
		_defaultReader = (reader as DeserializingResourceReader) ?? throw new ArgumentException(System.SR.Format(System.SR.NotSupported_WrongResourceReader_Type, reader.GetType()), "reader");
	...
	{
		return (_defaultReader ?? throw new ObjectDisposedException(null, System.SR.ObjectDisposed_ResourceSet)).GetEnumerator();
	}
	...
	{
		System.ExceptionPolyfills.ThrowIfNull(key, "key");
		...
		{
			throw new ObjectDisposedException(null, System.SR.ObjectDisposed_ResourceSet);
		}
