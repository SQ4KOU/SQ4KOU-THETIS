...
internal class DiscordSocketApiClient : DiscordRestApiClient
{
	...
	public Task SendIdentifyAsync(int largeThreshold = 100, int shardID = 0, int totalShards = 1, GatewayIntents gatewayIntents = GatewayIntents.AllUnprivileged, (UserStatus, bool, long?, Game)? presence = null, RequestOptions options = null)
	{
		...
		return SendGatewayAsync(GatewayOpCode.Identify, identifyParams, options);
	}
	...
	public Task SendResumeAsync(string sessionId, int lastSeq, RequestOptions options = null)
	{
		...
		return SendGatewayAsync(GatewayOpCode.Resume, payload, options);
	}

	public Task SendHeartbeatAsync(int lastSeq, RequestOptions options = null)
	{
		options = RequestOptions.CreateOrClone(options);
		return SendGatewayAsync(GatewayOpCode.Heartbeat, lastSeq, options);
	}

	public Task SendPresenceUpdateAsync(UserStatus status, bool isAFK, long? since, Game game, RequestOptions options = null)
	{
		options = RequestOptions.CreateOrClone(options);
		...
		return SendGatewayAsync(GatewayOpCode.PresenceUpdate, payload, options);
	}

	public Task SendRequestMembersAsync(IEnumerable<ulong> guildIds, RequestOptions options = null)
	{
		options = RequestOptions.CreateOrClone(options);
		return SendGatewayAsync(GatewayOpCode.RequestGuildMembers, new RequestMembersParams
		{
			GuildIds = guildIds,
			Query = "",
			Limit = 0
	...
	public Task SendVoiceStateUpdateAsync(ulong guildId, ulong? channelId, bool selfDeaf, bool selfMute, RequestOptions options = null)
	{
		...
		options = RequestOptions.CreateOrClone(options);
		return SendGatewayAsync(GatewayOpCode.VoiceStateUpdate, payload, options);
	}
	...
	{
		options = RequestOptions.CreateOrClone(options);
		return SendGatewayAsync(GatewayOpCode.GuildSync, guildIds, options);
	}
}
