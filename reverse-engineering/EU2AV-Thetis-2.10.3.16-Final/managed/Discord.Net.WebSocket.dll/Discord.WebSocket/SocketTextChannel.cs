...
public class SocketTextChannel : SocketGuildChannel, ITextChannel, IMessageChannel, IChannel, ISnowflakeEntity, IEntity<ulong>, IMentionable, INestedChannel, IGuildChannel, IDeletable, IIntegrationChannel, ISocketMessageChannel
{
	...
	public IReadOnlyCollection<SocketMessage> CachedMessages => (IReadOnlyCollection<SocketMessage>)(_messages?.Messages ?? ((object)ImmutableArray.Create<SocketMessage>()));
	...
	{
		return await GetActiveThreadsAsync(options);
	}
