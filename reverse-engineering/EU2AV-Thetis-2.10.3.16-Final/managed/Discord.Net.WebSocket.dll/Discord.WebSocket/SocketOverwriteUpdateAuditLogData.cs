...
public class SocketOverwriteUpdateAuditLogData : ISocketAuditLogData, IAuditLogData
{
	...
	internal static SocketOverwriteUpdateAuditLogData Create(DiscordSocketClient discord, AuditLogEntry entry)
	{
		...
		return new SocketOverwriteUpdateAuditLogData(entry.TargetId.Value, before, after, entry.Options.OverwriteTargetId.Value, overwriteType);
	}
}
