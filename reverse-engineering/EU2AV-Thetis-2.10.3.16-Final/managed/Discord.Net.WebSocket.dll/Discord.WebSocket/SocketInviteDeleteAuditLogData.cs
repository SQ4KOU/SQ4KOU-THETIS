...
public class SocketInviteDeleteAuditLogData : ISocketAuditLogData, IAuditLogData
{
	...
	internal static SocketInviteDeleteAuditLogData Create(DiscordSocketClient discord, AuditLogEntry entry)
	{
		...
		return new SocketInviteDeleteAuditLogData(data, inviter);
	}
}
