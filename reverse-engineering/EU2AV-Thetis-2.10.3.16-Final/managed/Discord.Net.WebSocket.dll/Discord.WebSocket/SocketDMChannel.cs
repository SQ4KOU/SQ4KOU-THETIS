...
public class SocketDMChannel : SocketChannel, IDMChannel, IMessageChannel, IChannel, ISnowflakeEntity, IEntity<ulong>, IPrivateChannel, ISocketPrivateChannel, ISocketMessageChannel
{
	...
	public new IReadOnlyCollection<SocketUser> Users => ImmutableArray.Create(base.Discord.CurrentUser, Recipient);
