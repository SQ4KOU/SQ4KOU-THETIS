...
internal class ClientState
{
	...
	public ClientState(int guildCount, int dmChannelCount)
	{
		...
		_entitlements = new ConcurrentDictionary<ulong, SocketEntitlement>();
		_subscriptions = new ConcurrentDictionary<ulong, SocketSubscription>();
	}
	...
	{
		if (_entitlements.TryGetValue(id, out var value))
		{
			return value;
		}
		return null;
	...
	{
		if (_entitlements.TryRemove(id, out var value))
		{
			return value;
		}
		return null;
	...
	{
		if (_subscriptions.TryGetValue(id, out var value))
		{
			return value;
		}
		return null;
	...
	{
		if (_subscriptions.TryRemove(id, out var value))
		{
			return value;
		}
		return null;
