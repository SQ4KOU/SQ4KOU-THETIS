...
public static class EmbedBuilderExtensions
{
	...
	{
		return builder.WithAuthor((user.DiscriminatorValue != 0) ? (user.Username + "#" + user.Discriminator) : user.Username, user.GetAvatarUrl(ImageFormat.Auto, 128) ?? user.GetDefaultAvatarUrl());
	}
