...
public interface IGuild : IDeletable, ISnowflakeEntity, IEntity<ulong>
{
	...
	Task BanUserAsync(IUser user, uint pruneSeconds = 0u, RequestOptions options = null);

	Task BanUserAsync(ulong userId, uint pruneSeconds = 0u, RequestOptions options = null);
