...
public class SlashCommandBuilder
{
	...
	{
		Preconditions.AtLeast(ContextTypes?.Count ?? 1, 1, "ContextTypes", "At least 1 context type must be specified");
		Preconditions.AtLeast(IntegrationTypes?.Count ?? 1, 1, "IntegrationTypes", "At least 1 integration type must be specified");
		...
		HashSet<InteractionContextType> contextTypes = ContextTypes;
		obj.ContextTypes = ((contextTypes != null) ? ((Optional<HashSet<InteractionContextType>>)contextTypes) : Optional<HashSet<InteractionContextType>>.Unspecified);
		HashSet<ApplicationIntegrationType> integrationTypes = IntegrationTypes;
		obj.IntegrationTypes = ((integrationTypes != null) ? ((Optional<HashSet<ApplicationIntegrationType>>)integrationTypes) : Optional<HashSet<ApplicationIntegrationType>>.Unspecified);
		SlashCommandProperties slashCommandProperties = obj;
