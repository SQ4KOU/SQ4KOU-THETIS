...
internal static class ILOpCodeExtensions
{
	...
	{
		if (opcode - 40 <= ILOpCode.Ldarg_0 || opcode == ILOpCode.Callvirt || opcode == ILOpCode.Newobj)
		{
			return true;
		}
		return false;
	...
	{
		if (opcode - 44 <= ILOpCode.Stloc_1 || opcode - 57 <= ILOpCode.Stloc_1)
		{
			return true;
		}
		return false;
	...
	{
		if (opcode - 46 <= ILOpCode.Ldloc_3 || opcode - 59 <= ILOpCode.Ldloc_3)
		{
			return true;
		}
		return false;
