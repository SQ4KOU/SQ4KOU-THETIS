...
internal sealed class SlicePatternOperation : BasePatternOperation, ISlicePatternOperation, IPatternOperation, IOperation
{
	...
	{
		return visitor.VisitSlicePattern(this, argument);
	}
}
