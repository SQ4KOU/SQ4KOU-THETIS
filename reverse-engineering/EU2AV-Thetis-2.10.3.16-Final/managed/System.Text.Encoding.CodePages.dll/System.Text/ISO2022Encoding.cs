...
internal sealed class ISO2022Encoding : System.Text.DBCSCodePageEncoding
{
	...
	private static ReadOnlySpan<int> TableBaseCodePages => new ReadOnlySpan<int>(new int[12]
	{
		932, 932, 932, 0, 0, 949, 936, 0, 0, 0,
		0, 0
	});

	private static ReadOnlySpan<ushort> HalfToFullWidthKanaTable => new ReadOnlySpan<ushort>(new ushort[63]
	{
