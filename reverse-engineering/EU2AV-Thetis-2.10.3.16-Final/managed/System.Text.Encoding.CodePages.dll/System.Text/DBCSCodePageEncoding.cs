...
internal class DBCSCodePageEncoding : System.Text.BaseCodePageEncoding
{
	...
	[CompilerGenerated]
	private static object _003CInternalSyncObject_003Ek__BackingField;

	private static object InternalSyncObject => _003CInternalSyncObject_003Ek__BackingField ?? Interlocked.CompareExchange(ref _003CInternalSyncObject_003Ek__BackingField, new object(), null) ?? _003CInternalSyncObject_003Ek__BackingField;
	...
	protected unsafe override void LoadManagedCodePage()
	{
		fixed (byte* ptr = &m_codePageHeader[0])
		{
			...
			mapUnicodeToBytes = (ushort*)nativeMemory + 65536;
			...
			lock (System.Text.BaseCodePageEncoding.s_streamLock)
			{
				...
				System.Text.BaseCodePageEncoding.s_codePagesEncodingDataStream.Read(array, 0, m_dataSize);
			}
