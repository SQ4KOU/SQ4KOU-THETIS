...
public class CommandService : IDisposable
{
	...
	public bool TryRemoveTypeReader(Type type, bool isDefaultTypeReader, out IDictionary<Type, TypeReader> readers)
	{
		...
		{
			bool num = _defaultTypeReaders.TryRemove(type, out var value);
			if (num)
			{
		...
		bool num2 = _typeReaders.TryRemove(type, out var value2);
		if (num2)
		{
			readers = value2;
		}
	...
	public SearchResult Search(string input)
	{
		...
		ImmutableArray<CommandMatch> immutableArray = (from x in _map.GetCommands(text)
