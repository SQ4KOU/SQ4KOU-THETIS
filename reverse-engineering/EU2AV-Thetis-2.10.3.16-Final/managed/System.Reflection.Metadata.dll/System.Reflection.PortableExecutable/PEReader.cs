...
public sealed class PEReader : IDisposable
{
	...
	public unsafe PEReader(Stream peStream, PEStreamOptions options, int size)
	{
		...
		try
		{
			...
			else if ((options & PEStreamOptions.PrefetchEntireImage) != PEStreamOptions.Default)
			{
				...
				{
					_lazyPEHeaders = new PEHeaders(nativeHeapMemoryBlock.GetStream(), nativeHeapMemoryBlock.Size, IsLoadedImage);
				}
			}
			else
			{
				_lazyPEHeaders = new PEHeaders(peStream, andValidateSize, IsLoadedImage);
				if (_lazyPEHeaders.MetadataStartOffset != -1)
				{
					_lazyMetadataBlock = System.Reflection.Internal.StreamMemoryBlockProvider.ReadMemoryBlockNoLock(peStream, position + _lazyPEHeaders.MetadataStartOffset, _lazyPEHeaders.MetadataSize);
				}
			}
		}
		finally
	...
	[System.Diagnostics.CodeAnalysis.MemberNotNull("_lazyPEHeaders")]
	private void InitializePEHeaders()
	{
		...
		if (pEImage.TryGetUnderlyingStream(out Stream stream, out long imageStart, out int imageSize, out object streamGuard))
		{
			lock (streamGuard)
			{
				...
				value = new PEHeaders(stream, imageSize, IsLoadedImage);
			}
		}
		else
		{
			System.Reflection.Internal.AbstractMemoryBlock memoryBlock = pEImage.GetMemoryBlock();
			value = new PEHeaders(memoryBlock.GetStream(), memoryBlock.Size, IsLoadedImage);
		}
	...
	private System.Reflection.Internal.AbstractMemoryBlock GetPESectionBlock(int index)
	{
		...
		System.Reflection.Internal.AbstractMemoryBlock abstractMemoryBlock = Volatile.Read(ref _lazyPESectionBlocks[index]);
		if (abstractMemoryBlock != null)
		{
			return abstractMemoryBlock;
		}
	...
	public CodeViewDebugDirectoryData ReadCodeViewDebugDirectoryData(DebugDirectoryEntry entry)
	{
		...
		{
			System.Reflection.Throw.InvalidArgument(System.SR.Format(System.SR.UnexpectedDebugDirectoryType, "CodeView"), "entry");
		}
	...
	public PdbChecksumDebugDirectoryData ReadPdbChecksumDebugDirectoryData(DebugDirectoryEntry entry)
	{
		...
		{
			System.Reflection.Throw.InvalidArgument(System.SR.Format(System.SR.UnexpectedDebugDirectoryType, "PdbChecksum"), "entry");
		}
		using System.Reflection.Internal.AbstractMemoryBlock block = GetDebugDirectoryEntryDataBlock(entry);
	...
	internal static PdbChecksumDebugDirectoryData DecodePdbChecksumDebugDirectoryData(System.Reflection.Internal.AbstractMemoryBlock block)
	{
		...
		return new PdbChecksumDebugDirectoryData(text, ImmutableCollectionsMarshal.AsImmutableArray(array));
	}
	...
	public bool TryOpenAssociatedPortablePdb(string peImagePath, Func<string, Stream?> pdbFileStreamProvider, out MetadataReaderProvider? pdbReaderProvider, out string? pdbPath)
	{
		...
		ImmutableArray<DebugDirectoryEntry> immutableArray = ReadDebugDirectory();
	...
	public MetadataReaderProvider ReadEmbeddedPortablePdbDebugDirectoryData(DebugDirectoryEntry entry)
	{
		...
		{
			System.Reflection.Throw.InvalidArgument(System.SR.Format(System.SR.UnexpectedDebugDirectoryType, "EmbeddedPortablePdb"), "entry");
		}
	...
	internal static void ValidateEmbeddedPortablePdbVersion(DebugDirectoryEntry entry)
	{
		...
		if (majorVersion < 256)
		{
			throw new BadImageFormatException(System.SR.Format(System.SR.UnsupportedFormatVersion, System.Reflection.Metadata.PortablePdbVersions.Format(majorVersion)));
		}
		ushort minorVersion = entry.MinorVersion;
		if (minorVersion != 256)
		{
			throw new BadImageFormatException(System.SR.Format(System.SR.UnsupportedFormatVersion, System.Reflection.Metadata.PortablePdbVersions.Format(minorVersion)));
		}
	}
	...
	internal unsafe static System.Reflection.Internal.NativeHeapMemoryBlock DecodeEmbeddedPortablePdbDebugDirectoryData(System.Reflection.Internal.AbstractMemoryBlock block)
	{
		...
		{
			throw new BadImageFormatException(System.SR.DataTooBig, inner);
		}
		bool flag = false;
		try
		{
			using DeflateStream deflateStream = new DeflateStream(new UnmanagedMemoryStream(reader.CurrentPointer, reader.RemainingBytes), CompressionMode.Decompress, leaveOpen: true);
			if (num > 0)
			{
				int num2;
				try
