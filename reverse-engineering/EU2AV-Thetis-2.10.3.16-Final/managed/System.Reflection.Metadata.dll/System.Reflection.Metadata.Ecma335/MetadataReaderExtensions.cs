...
public static class MetadataReaderExtensions
{
	...
	public static IEnumerable<EditAndContinueLogEntry> GetEditAndContinueLogEntries(this MetadataReader reader)
	{
		...
		return Core(reader);
		static IEnumerable<EditAndContinueLogEntry> Core(MetadataReader metadataReader)
		{
			for (int rid = 1; rid <= metadataReader.EncLogTable.NumberOfRows; rid++)
			{
				yield return new EditAndContinueLogEntry(new EntityHandle(metadataReader.EncLogTable.GetToken(rid)), metadataReader.EncLogTable.GetFuncCode(rid));
			}
		}
	}
	...
	public static IEnumerable<EntityHandle> GetEditAndContinueMapEntries(this MetadataReader reader)
	{
		...
		return Core(reader);
		static IEnumerable<EntityHandle> Core(MetadataReader metadataReader)
		{
			for (int rid = 1; rid <= metadataReader.EncMapTable.NumberOfRows; rid++)
			{
				yield return new EntityHandle(metadataReader.EncMapTable.GetToken(rid));
			}
		}
	}
	...
	public static IEnumerable<TypeDefinitionHandle> GetTypesWithProperties(this MetadataReader reader)
	{
		...
		return Core(reader);
		static IEnumerable<TypeDefinitionHandle> Core(MetadataReader metadataReader)
		{
			for (int rid = 1; rid <= metadataReader.PropertyMapTable.NumberOfRows; rid++)
			{
				yield return metadataReader.PropertyMapTable.GetParentType(rid);
			}
		}
	}
	...
	public static IEnumerable<TypeDefinitionHandle> GetTypesWithEvents(this MetadataReader reader)
	{
		...
		static IEnumerable<TypeDefinitionHandle> Core(MetadataReader metadataReader)
		{
			for (int rid = 1; rid <= metadataReader.EventMapTable.NumberOfRows; rid++)
			{
				yield return metadataReader.EventMapTable.GetParentType(rid);
			}
		}
	}
