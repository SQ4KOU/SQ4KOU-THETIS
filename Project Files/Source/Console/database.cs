    ...
    class DB
    {
        ...
        private static void AddBandTextSWB()
        {
            ...
            object[] data = {
                                ...
                                26.330000, 26.959999, "11M Band",               true,

								// 11M Citizens Band channel plan (ch 1-40) + freeband (ch 41-80)
                                ...
                                27.810000, 27.865000, "11M Band",               true
                            };
        ...
        public static void UpdateRegion(FRSRegion current_region)
        {
            ...
            switch (current_region)
            {
                ...
                case FRSRegion.Russia:
                    ...
                    // CB channel plan is now provided universally by AddBandTextSWB();
                    // the old Russia "11M Citizens Band" row overlapped it
